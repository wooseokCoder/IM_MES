-- ============================================================
-- Video.xml -> 프로시저 전환 스크립트
-- 생성일: 2026-01-14
-- 파일: sp_video_procedures.sql
-- 설명: Video 게시판 관련 프로시저 (SYS_BORD, SYS_BORD_TGT)
-- ============================================================
...
-- [sp_video_search] 게시글 목록 조회 (페이징 및 동적 검색)
DROP PROCEDURE IF EXISTS sp_video_search//
CREATE PROCEDURE sp_video_search(
...
-- [sp_video_search_count] 게시글 카운트
DROP PROCEDURE IF EXISTS sp_video_search_count//
CREATE PROCEDURE sp_video_search_count(
    IN p_sys_id VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_use_flag VARCHAR(1),
    IN p_regi_id VARCHAR(50),
...
-- [sp_video_select] 게시글 상세 조회
DROP PROCEDURE IF EXISTS sp_video_select//
CREATE PROCEDURE sp_video_select(
    IN p_sys_id VARCHAR(20),
...
BEGIN
    ...
    -- PK 자동 생성: B000000001, B000000002, ...
...
-- [sp_video_update] 게시글 수정
DROP PROCEDURE IF EXISTS sp_video_update//
...
-- [sp_video_delete] 게시글 물리 삭제
DROP PROCEDURE IF EXISTS sp_video_delete//
...
-- [sp_video_update_read_cnt] 조회수 증가
DROP PROCEDURE IF EXISTS sp_video_update_read_cnt//
CREATE PROCEDURE sp_video_update_read_cnt(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20)
)
...
-- [sp_video_update_disable] 게시글 사용안함 처리
DROP PROCEDURE IF EXISTS sp_video_update_disable//
CREATE PROCEDURE sp_video_update_disable(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_gs_user_id VARCHAR(50)
...
-- [sp_video_search_target] 대상자 목록 조회
DROP PROCEDURE IF EXISTS sp_video_search_target//
CREATE PROCEDURE sp_video_search_target(
    IN p_sys_id VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_use_flag VARCHAR(1),
    IN p_bord_no VARCHAR(20),
...
-- [sp_video_search_target_count] 대상자 목록 카운트
DROP PROCEDURE IF EXISTS sp_video_search_target_count//
CREATE PROCEDURE sp_video_search_target_count(
    IN p_sys_id VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_use_flag VARCHAR(1),
    IN p_bord_no VARCHAR(20),
...
-- [sp_video_select_target] 대상자 단건 조회
DROP PROCEDURE IF EXISTS sp_video_select_target//
CREATE PROCEDURE sp_video_select_target(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
...
-- [sp_video_insert_target] 대상자 등록
-- p_targets: 콤마로 구분된 사용자 ID 목록 (예: 'user1,user2,user3')
DROP PROCEDURE IF EXISTS sp_video_insert_target//
CREATE PROCEDURE sp_video_insert_target(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_targets TEXT,
...
-- [sp_video_update_target] 대상자 정보 수정
DROP PROCEDURE IF EXISTS sp_video_update_target//
CREATE PROCEDURE sp_video_update_target(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_tgt_user_id VARCHAR(50),
...
-- [sp_video_update_target_disable] 대상자 비활성화 처리
DROP PROCEDURE IF EXISTS sp_video_update_target_disable//
CREATE PROCEDURE sp_video_update_target_disable(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_tgt_user_id VARCHAR(50),
...
-- [sp_video_delete_target_all] 대상자 일괄 삭제
DROP PROCEDURE IF EXISTS sp_video_delete_target_all//
CREATE PROCEDURE sp_video_delete_target_all(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20)
)
...
-- [sp_video_update_target_read] 대상자 읽음 처리
DROP PROCEDURE IF EXISTS sp_video_update_target_read//
CREATE PROCEDURE sp_video_update_target_read(
    IN p_sys_id VARCHAR(20),
    IN p_bord_no VARCHAR(20),
    IN p_bord_grup VARCHAR(20),
    IN p_tgt_user_id VARCHAR(50)
