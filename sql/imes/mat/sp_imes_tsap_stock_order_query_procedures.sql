-- ============================================================================
-- 파일명: sp_imes_tsap_stock_order_query_procedures.sql
-- 설명: 재고정보 조회 - 판매오더재고 (TSAP_STOCK_ORDER 테이블)
-- 원본: ProActive TSAP_STOCK_ORDER_QUERY.cs
-- 작성일: 2026-03-03
-- ============================================================================

-- ============================================================================
-- sp_imes_tsap_stock_order_query1
-- 용도: MAT02A 판매오더재고 조회
-- 원본: TSAP_STOCK_ORDER_QUERY.TSAP_STOCK_ORDER_QUERY1
--
-- AS-IS SQL:
--   SELECT S.PART_CODE, S.PART_NAME, S.PLANTS, S.STK_LOC,
--          S.QTY, S.QINS_FLAG, S.HINS_FLAG, S.PART_UNIT,
--          S.BATCH_NO, S.STK_EMP AS STOCK_EMP, S.ORDER_NO, S.ORDER_LINE
--   FROM TSAP_STOCK_ORDER S
...
DROP PROCEDURE IF EXISTS sp_imes_tsap_stock_order_query1//

CREATE PROCEDURE sp_imes_tsap_stock_order_query1(
...
BEGIN
    SELECT
        ...
        ,S.STK_EMP                                              AS stockEmp
        ,S.ORDER_NO                                             AS orderNo
        ,S.ORDER_LINE                                           AS orderLine
        ,NULL                                                   AS cvndCode
        ,NULL                                                   AS cvndName
        ,NULL                                                   AS mvndCode
        ,NULL                                                   AS mvndName
