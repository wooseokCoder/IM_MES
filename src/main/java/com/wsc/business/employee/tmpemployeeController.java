...
public class tmpemployeeController extends BaseController {
	@Autowired
	private tmpemployeeService service;
	...
	@RequestMapping(value = "/tmpemployee.do")
	public String open(HttpServletRequest request, Model model) {		
		
		ParamsMap params = getParams(request);
		String[] codeGrupList =  {"EXIT_YN","BUSI_CHARGE"};
	...
	@RequestMapping(value = "/tmpemployee/search.json")
	...
	@RequestMapping(value = "/tmpemployee/download.do")
	public String download(HttpServletRequest request, Model model) {
		return super.download(request, model);
	}

	@RequestMapping(value = "/tmpemployee/select.json")
	public String select(HttpServletRequest request, Model model) {
		return super.select(request, model);
	}

	@RequestMapping(value = "/tmpemployee/save.json")
	public String save(HttpServletRequest request, Model model) {
		return super.save(request, model);
	}

	@RequestMapping(value = "/tmpemployee/delete.json")
	public String delete(HttpServletRequest request, Model model) {
		return super.save(request, model);
	}

	@RequestMapping(value = "/tmpemployee/getEmplNo.json")
