...
@Controller
@RequestMapping("/common/board/lsqna/")
public class LsqnaController extends BaseController {
	...
	private String openNotice(HttpServletRequest request, Model model, String name) {
		...
		//게시물 작성자
		if (params.containsKey("bordNo") == true) {
			model.addAttribute("cUserId", service.search(params, "getRegiUserId"));
		}
	...
	public String openForm(HttpServletRequest request, Model model) {
		return openNotice(request, model, "lsqnaForm");
	}
	
	//상세조회 오픈
	@RequestMapping(value = "/view.do")
	public String openView(HttpServletRequest request, Model model) {
		return openNotice(request, model, "lsqnaView");
	}
	...
	public String replyList(HttpServletRequest request, Model model) {
    	...
    	Object result = qnaservice.search("selectReplyList", params);
	...
	public String replyView(HttpServletRequest request, Model model) {
    	...
    	Object result = qnaservice.search("selectReplyView", params);
