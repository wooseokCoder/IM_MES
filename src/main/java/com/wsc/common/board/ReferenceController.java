 ...
 */
@Controller
@RequestMapping("/common/board/reference")
public class ReferenceController extends BaseController {
	...
	//게시판그룹
	private BoardGroup group = BoardGroup.DATA;
	...
	public String openForm(HttpServletRequest request, Model model) {
		...
		return openBoard(request, model, "referenceForm");
	}
	
	//상세조회화면 오픈
	@RequestMapping(value = "/view.do")
	public String openView(HttpServletRequest request, Model model) {
		return openBoard(request, model, "referenceView");
	}
