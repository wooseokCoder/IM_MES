...
@Controller
@RequestMapping("/common/board/lsnews/")
public class LsnewsController extends BaseController {
	...
	//공지사항 오픈
	@RequestMapping(value = "/lsnews.do")
	...
	public String openForm(HttpServletRequest request, Model model) {
		return openNotice(request, model, "lsnewsForm");
	}
	
	//상세조회 오픈
	@RequestMapping(value = "/view.do")
	public String openView(HttpServletRequest request, Model model) {
		return openNotice(request, model, "lsnewsView");
	}
