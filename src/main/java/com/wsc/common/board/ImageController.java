 ...
 */
@Controller
@RequestMapping("/common/board/image")
public class ImageController extends BaseController {
	...
	//게시판그룹
	private BoardGroup group = BoardGroup.IMAGE;
...
/*		//[WSC2.0] [2015.04 LSH] 상단정보 설정
	...
	public String openForm(HttpServletRequest request, Model model) {
		...
		return openBoard(request, model, "imageForm");
	}

	//상세조회화면 오픈
	@RequestMapping(value = "/view.do")
	public String openView(HttpServletRequest request, Model model) {
		return openBoard(request, model, "imageView");
	}
