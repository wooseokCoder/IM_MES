 ...
 */
@Controller
@RequestMapping("/common/board/notification")
public class NotificationController extends BaseController {
	...
	//게시판그룹
	private BoardGroup group = BoardGroup.NOTIFICATION;
...
/*		//[WSC2.0] [2015.04 LSH] 상단정보 설정
	...
	public String openForm(HttpServletRequest request, Model model) {
		...
		return openBoard(request, model, "qnaForm");
	}
	
	//상세조회화면 오픈
	@RequestMapping(value = "/view.do")
	public String openView(HttpServletRequest request, Model model) {
		return openBoard(request, model, "qnaView");
	}
	...
	@RequestMapping(value = "/reply.json")
	public String replyList(HttpServletRequest request, Model model) {
		// 파라메터를 가져온다.
    	ParamsMap params = getParams(request, true);
    	
    	params.add("bordGrup", group.getCode());
    	
    	Object result = service.search("selectReplyList", params);
	...
	@RequestMapping(value = "/replyView.json")
	public String replyView(HttpServletRequest request, Model model) {
    	...
    	Object result = service.search("selectReplyView", params);
	...
	@RequestMapping(value = "/getNotiList.json")
	public String getNotiList(HttpServletRequest request, Model model) {
		// 파라메터를 가져온다.
    	ParamsMap params = getParams(request, true);
    	
    	params.add("bordGrup", group.getCode());
    	
    	Object result = service.search("selectBordList", params);
	...
	@RequestMapping(value = "/updateNotiRead.json")
	public String updateNotiRead(HttpServletRequest request, Model model) {
		// 파라메터를 가져온다.
    	ParamsMap params = getParams(request, true);
    	
    	params.add("bordGrup", group.getCode());
    	
    	Object result = service.update("updateNotiRead", params);
