 ...
 */
@Controller
@RequestMapping("/common/code3")
public class Code3Controller extends BaseController {
	
	@Autowired 
	private Code3Service service;
	...
	@RequestMapping(value = "/code3.do")
	public String open(HttpServletRequest request, Model model) {
		ParamsMap params = getParams(request);
		Object result = codeService.search("getSelectCode", params);
		Object result2 = codeService.search("getSelectCodeSort", params);
		...
		Object result3 = codeService.search("searchCode", params);
	...
	//코드 검색
	@RequestMapping(value = "/code3.json")
	...
	public String selectDealerInfo(HttpServletRequest request, Model model) {
	    ...
	    Object result = codeService.insert("updateExtChr",params);
	...
	public String selectDealerInfo2(HttpServletRequest request, Model model) {
	    ...
	    Object result = codeService.insert("updateExtNum",params);
