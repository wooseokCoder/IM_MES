...
public class Program3Controller extends BaseController {
	
	@Autowired 
	private Program3Service service;
	...
	// 사용자화면관리
	//=====================================================//
	@RequestMapping(value = "/userprogram3.do")
	public String openUserProgram(HttpServletRequest request, Model model) {
		return super.open(request, model, "userprogram3");
	}

	@RequestMapping(value = "/userprogram3/search.json")
	...
	@RequestMapping(value = "/userprogram3/download.do")
	...
	@RequestMapping(value = "/userprogram3/save.json")
	...
	// 그룹화면관리
	//=====================================================//
	@RequestMapping(value = "/groupprogram3.do")
	public String openGroupProgram(HttpServletRequest request, Model model) {
		return super.open(request, model, "groupprogram3");
	}

	@RequestMapping(value = "/groupprogram3/search.json")
	...
	@RequestMapping(value = "/groupprogram3/download.do")
	...
	@RequestMapping(value = "/groupprogram3/save.json")
