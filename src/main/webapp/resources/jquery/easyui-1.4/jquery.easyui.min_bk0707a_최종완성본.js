...
if(_1ff){
//BBUG.CHG : 메뉴접기 이전 모습 Split영역  minWidth:_1ff.minWidth -> 5
$.extend(opts,{width:_1ff.width,height:_1ff.height,minWidth:5,maxWidth:_1ff.maxWidth,minHeight:_1ff.minHeight,maxHeight:_1ff.maxHeight,left:_1ff.left,top:_1ff.top});
}
_201._size(opts);
...
//BBUG.CHG : 접혔을 때 Size 초기값 변경..,  _39b.collapsedSize  ->  5
...
var _5c6=_5c5(tr);
// BBUG.CHECK : datagrid-row-over
//alert("jquery.easyui.min.js : datagrid-row-over - 111");
...
//BBUG.CHG : datagrid-row-over 시 datagrid-row-alt, datagrid-row-selected 처리
//-> datagrid-row-selected 는 정리가 잘 안되어 일단 보류~
//alert("jquery.easyui.min.js : datagrid-row-over - 222");
opts.finder.getTr(_62f,_631.highlightIndex).removeClass("datagrid-row-over");
opts.finder.getTr(_62f,_631.highlightIndex).addClass(function(){ return (_631.highlightIndex%2&&!opts.finder.getTr(_62f,_631.highlightIndex).hasClass("datagrid-row-selected-check")?"datagrid-row-alt":"");});
opts.finder.getTr(_62f,_631.highlightIndex).addClass(function(){ return (opts.finder.getTr(_62f,_631.highlightIndex).hasClass("datagrid-row-selected-check")?"datagrid-row-selected":"");});
opts.finder.getTr(_62f,_630).removeClass("datagrid-row-alt");
opts.finder.getTr(_62f,_630).removeClass("datagrid-row-selected");
//opts.finder.getTr(_62f,_630).removeClass(function(){ return (opts.finder.getTr(_62f,_630).hasClass("datagrid-row-selected-check")?"datagrid-row-selected":"");});
//opts.finder.getTr(_62f,_630).removeClass(function(){ return (!opts.multiple?"datagrid-row-selected":"");});
opts.finder.getTr(_62f,_630).removeClass(function(){ return (opts.singleSelect?"datagrid-row-selected-check":"");});
...
//alert("jquery.easyui.min.js : datagrid-row-selected - 000");
if(opts.singleSelect){
	//alert("jquery.easyui.min.js : datagrid-row-selected - singleSelect");
_638(_633);
_637.splice(0,_637.length);
}
if(!_635&&opts.checkOnSelect){
	//alert("jquery.easyui.min.js : datagrid-row-selected - checkOnSelect");
_639(_633,_634,true);
}
var row=opts.finder.getRow(_633,_634);
if(opts.idField){
	//alert("jquery.easyui.min.js : datagrid-row-selected - idField");
_561(_637,opts.idField,row);
}
//BBUG.CHG : datagrid-row-over 시 datagrid-row-alt, datagrid-row-selected 처리
//여기 통과하면서 무조건 선택됨...a~c까지
//alert("jquery.easyui.min.js : datagrid-row-selected - 111");

if(!opts.finder.getTr(_633,_634).hasClass("datagrid-row-selected-check")){
opts.finder.getTr(_633,_634).addClass("datagrid-row-selected");
opts.finder.getTr(_633,_634).addClass("datagrid-row-selected-check");

//opts.finder.getTr(_633,_634).addClass(function(){ return (!opts.finder.getTr(_633,_634).hasClass("datagrid-row-selected-check")?"datagrid-row-selected":"");});
//opts.finder.getTr(_633,_634).addClass(function(){ return (!opts.finder.getTr(_633,_634).hasClass("datagrid-row-selected-check")?"datagrid-row-selected-check":"");});
//alert("jquery.easyui.min.js : datagrid-row-selected - 111a");
opts.onSelect.call(_633,_634,row);
//alert("jquery.easyui.min.js : datagrid-row-selected - 111b");
_627(_633,_634);
//alert("jquery.easyui.min.js : datagrid-row-selected - 111c");
}
else {
	_640(_633,_634,true);
	opts.finder.getTr(_633,_634).removeClass("datagrid-row-selected");
	opts.finder.getTr(_633,_634).removeClass("datagrid-row-selected-check");
	opts.onUnselect.call(_633,_634,row);
}
};
//alert("jquery.easyui.min.js : datagrid-row-selected - 111d");
...
//alert("jquery.easyui.min.js : datagrid-row-selected - 112a");
_640(_63b,_63c,true);
}
opts.finder.getTr(_63b,_63c).removeClass("datagrid-row-selected");
opts.finder.getTr(_63b,_63c).removeClass("datagrid-row-selected-check");
...
//BBUG.CHG : datagrid-row-over 시 datagrid-row-alt, datagrid-row-selected 처리
//alert("jquery.easyui.min.js : datagrid-row-selected - 222");
opts.finder.getTr(_642,"","allbody").addClass("datagrid-row-selected");
opts.finder.getTr(_642,"","allbody").addClass("datagrid-row-selected-check");
if(opts.idField){
for(var _647=0;_647<rows.length;_647++){
_561(_645,opts.idField,rows[_647]);
}
}
//alert("jquery.easyui.min.js : onSelectAll - _642");
...
opts.finder.getTr(_648,"","selected").removeClass("datagrid-row-selected-check");
if(opts.idField){
...
//BBUG.ADD : 전체선택
opts.finder.getTr(_658,"","allbody").removeClass("datagrid-row-alt");
opts.finder.getTr(_658,"","allbody").addClass("datagrid-row-selected");
opts.finder.getTr(_658,"","allbody").addClass("datagrid-row-selected-check");
}
//alert( "onCheckAll - 222");
...
//BBUG.ADD : 전체해제 
for(var i=0;i<rows.length;i++){
opts.finder.getTr(_65b,i).addClass((i)%2?"datagrid-row-alt":"");
}
opts.finder.getTr(_65b,"","allbody").removeClass("datagrid-row-selected");
opts.finder.getTr(_65b,"","allbody").removeClass("datagrid-row-selected-check");
}
//alert( "onUncheckAll - 222");
...
//BBUG.CHECK : To-Be - (i%2&&opts.striped?
//alert("jquery.easyui.min.js-001");
...
//BBUG.CHECK : To-Be
//alert("jquery.easyui.min.js-002");
...
//BBUG.CHECK : To-Be
//alert("jquery.easyui.min.js-003");
...
//BBUG.CHECK : To-Be
//alert("jquery.easyui.min.js-004");
