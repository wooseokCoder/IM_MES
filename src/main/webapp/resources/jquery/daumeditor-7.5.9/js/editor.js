...
(function() {
    ...
    (function() {
        ...
        Function.prototype.bindAsEventListener = function() {
            var A = this,
                ...
                B = C.shift();
            return function(D) {
                return A.apply(B, [D || h.event].concat(C))
            }
        };
        var y = function(C) {
            var A = arguments;
            if (A.length > 1) {
                for (var B = 0, E = [], D = A.length; B < D; B++) {
                    E.push(t(A[B]))
                }
                return E
            }
        ...
        Object.extend(t, {
            throttle: function(B, D, H) {
                var A, F, I;
                var G = null;
                var E = 0;
                H || (H = {});
                var C = function() {
                    E = H.leading === false ? 0 : z();
                    G = null;
                    I = B.apply(A, F);
                    A = F = null
                };
        ...
        Object.extend(t, {
            ...
            isArrayLike: function(A) {
                return d.isArrayLike(A)
            },
            isString: function(A) {
                return d.isString(A)
            },
            isBoolean: function(A) {
                return d.isBoolean(A)
            },
            isNumber: function(A) {
                return d.isNumber(A)
            },
        ...
        Object.extend(t, {
            ...
            msie8under: (t.msie && t.msie_ver <= 8),
            msie10under: (t.msie && t.msie_ver <= 10),
            msie_quirks: (function() {
                try {
                    return t.msie && h.top.document.compatMode !== "CSS1Compat"
                } catch (A) {
                    try {
        ...
        h.$must = function(C, A) {
            var B = t(C);
            if (!B) {
                throw new Error("[Exception] " + A + ": cannot find element: id='" + C + "'")
            }
            return B
        };
        h.txlib = y
    ...
    (function() {
        t.extend(t, {
            ...
            getOffset: function(y) {
                ...
                if ("getBoundingClientRect" in B.documentElement) {
                    var e = B.documentElement;
                    var A = B.defaultView || B.parentWindow;
                    var x = y.getBoundingClientRect();
                    var w = (A.pageYOffset || e.scrollTop) - (e.clientTop || 0);
                    var z = (A.pageXOffset || e.scrollLeft) - (e.clientLeft || 0);
                    return {
                        top: x.top + w,
                        bottom: x.bottom + w,
                        left: x.left + z,
    ...
    (function() {
        t.extend(t, {
            ...
            pointerX: function(w) {
                var x = t.element(w).ownerDocument || b;
                var y = x.documentElement;
                var e = x.body;
                return w.pageX || (w.clientX + (y && y.scrollLeft || e && e.scrollLeft || 0) - (y && y.clientLeft || e && e.clientLeft || 0))
            },
            pointerY: function(w) {
                var x = t.element(w).ownerDocument || b;
                var y = x.documentElement;
                var e = x.body;
                return w.pageY || (w.clientY + (y && y.scrollTop || e && e.scrollTop || 0) - (y && y.clientTop || e && e.clientTop || 0))
            },
            stop: function(e) {
            ...
            _observeAndCache: function(y, x, w, e) {
                ...
                if ((t.msie_ver >= 11 || x != "resizestart" && x != "resizeend") && y.addEventListener) {
        ...
        var z = {
            ...
            ".": function(D, F) {
                if ((e = /(\S*)\.(\S+)/.exec(F)) !== i) {
                    ...
                    var E = D;
                    while (E) {
                        if (E.nodeName.toLowerCase() == "body" || E.nodeType === 9) {
                            break
                        }
    ...
    var g = {
        ...
        __EXCLUDE_IMG: ["txc-2image-c", "txc-3image-c", "txc-footnote", "txc-jukebox", "txc-movie", "txc-gallery", "txc-imazing", "txc-map", "txc-file", "txc-emo", "tx-entry-embed", "txc-bgm", "txc-pie"],
        I: {},
        X: {},
        define: function(e, w) {
    ...
    g.TableUtil = {
        ...
        collapseLastCaret: function(x, w) {
            var e;
            try {
                var y = w.length ? w.length : w.childNodes.length;
                e = x.getProcessor().createGoogRangeFromNodes(w, y, w, y);
                e.select()
            } catch (z) {}
        },
        ...
        getCellOffset: function(w) {
            var e = function(y, x) {
                return y["offset" + x.capitalize()] || parseInt(y[x] || y.style[x], 10)
            };
            return {
                width: e(w, "width"),
                height: e(w, "height")
    ...
    g.Responder = {
        ...
        register: function(w) {
            ...
            this.callbacks[e] = function(x) {
                w.apply(this, Array.prototype.slice.call(arguments, 0));
                this.callbacks[e] = i
            }.bind(this);
            return e
        }
    ...
    g.I.KeyObservable = g.Faculty.create({
        ...
        fireKeys: function(y, A) {
            ...
            this.keyObservers[x].each(function(B) {
                try {
                    B.apply(w, [y]);
                    !(B._bubble || A) && e()
                } catch (C) {
    ...
    g.I.point = g.Faculty.create({
        _getPointByEvent: function(B) {
            var z = t.element(B);
            var A = z.ownerDocument;
            var w = t.pointerX(B);
            var D = t.pointerY(B);
            if (A !== this._doc) {
                var C = t.getOffset(this._panel.el);
                return [w - C.left + (this._win.pageXOffset || this._doc.documentElement.scrollLeft), D - C.top + (this._win.pageYOffset || this._doc.documentElement.scrollTop)]
            }
            return [w, D]
        },
        _subtractPoint: function(w, e) {
            return [w[0] - e[0], w[1] - e[1]]
        },
        _addPoint: function(w, e) {
            return [w[0] + e[0], w[1] + e[1]]
        },
        _distancePoint: function(x, w) {
            var e = this._subtractPoint(x, w);
    ...
    (function() {
        ...
        Editor.forEachEditor = function(w) {
            var z, x = Editor.__MULTI_LIST;
            for (z in x) {
    ...
    g.I.Tool = {};
    g.I.Tool.QueryStyle = {};
    g.I.Tool.QueryStyle.Standard = g.Mixin.create({
        queryNodeStyle: function(y, x, e, w) {
            return t.getStyle(y, x).include(e)
        }
    });
    g.I.Tool.QueryStyle.Gecko = g.Mixin.create({
        queryNodeStyle: function(z, x, e, w) {
            var A = z;
            var y = c;
            while (A && !v.isBody(A) && !y) {
                if (v.isTagName(A, w)) {
                    y = u
                } else {
                    y = t.getStyle(z, x).include(e)
                }
                A = A.parentNode
            }
            return y
    ...
    g.Actor = g.Class.draft({
        ...
        existEntry: function() {
            var e = this.getDatalist().findAll(function(w) {
                return w.deletedMark != u
            });
            return e.length !== 0
        },
    ...
    g.Resizer = g.Class.create({
        ...
        initialize: function(x, e) {
            ...
            var y = x.getCanvas();
            y.observeJob(g.Ev.__CANVAS_FULL_SCREEN_CHANGE, function() {
                t.hide(w)
            });
            y.observeJob(g.Ev.__CANVAS_NORMAL_SCREEN_CHANGE, function() {
                t.show(w)
            })
        },
    ...
    ! function() {
        var e = h.Node ? Node.ELEMENT_NODE : 1;
        var w = h.Node ? Node.TEXT_NODE : 3;
        g.Paste = {
            I: {},
            isMSSelection: typeof h.getSelection != "function",
            MODE_OFF: "off",
            MODE_HTML: "html",
            MODE_TEXT: "text"
        };
        g.Paste.I.ProcessorBETA = g.Mixin.create({
            initialize: function(y, x) {
                this.editor = y;
                this.canvas = x;
                this.processor = null
            ...
            pasteContent: function(D) {
                var y = this.getProcessor();
                var E = y.createGoogRange();
                var H = this._getAnchorNodeByRange(E);
                var x = y.create("div");
                D = D.replace(/<\/p>\s+/gi, "</p>");
                D = D.replace(/<br class="Apple-interchange-newline">\s*/g, "");
                D = D.replace(/<\/(span|font|i|b|strong|center|i)>[\r\n]+/g, "</$1> ");
                D = this.cleanPasteHtml(D);
                x.innerHTML = D;
                var G = v.children(x);
                var F = c;
                var B = u;
                ...
                if (F) {
                    this._pasteTextOnly(G, E)
                } else {
                    this._pasteHtmlAndText(G, E, B, H)
                }
                this.removeDummyText()
            },
            cleanPasteHtml: function(x) {
                var y = this.getProcessor().create("div");
                y.innerHTML = x;
                return y.innerHTML
            },
            getDummyText: function() {
                if (!this.dummyText) {
                    this.dummyText = this.getProcessor().doc.createTextNode(g.__WORD_JOINER)
                }
                return this.dummyText
            },
            removeDummyText: function() {
                if (this.dummyText) {
                    v.remove(this.dummyText);
                    this.dummyText = i
                }
            },
            divideTree: function(E, B) {
                if (v.isBody(E)) {
                    return {
                        previousNode: null,
                        nextNode: null
                ...
                B = B || z.createGoogRange();
                var D = i,
                    x = i;
                var I;
                I = z.createGoogRangeFromNodes(E, 0, B.getFocusNode(), B.getFocusOffset());
                var y = I.getPastableHtml().trim();
                if (y !== "") {
                    D = E.cloneNode(false);
                    D.innerHTML = y;
                    v.insertAt(D, E);
                    if (D.childNodes.length == 1 && v.isElement(D.childNodes[0]) && D.tagName == D.childNodes[0].tagName) {
                        D = v.unwrap(D)
                    }
                    I = z.createGoogRangeFromNodes(E, 0, B.getFocusNode(), B.getFocusOffset());
                    I.select();
                ...
                var C = this.getDummyText();
                v.insertAt(C, E);
                var G = z.createGoogRangeFromNodes(C, C.length, C, C.length);
                G.select();
                var F = G.saveUsingCarets();
                var A = E.innerHTML.trim();
                if (A !== "") {
                    E.innerHTML = A;
                    x = E
                } else {
            ...
            _pasteTextOnly: function(x, y) {
                var A = x[0];
                y.insertNode(A);
                y = this.getProcessor().createGoogRangeFromNodes(A, v.getLength(A), A, v.getLength(A));
                var z = y.saveUsingCarets();
                z.restore();
                return y
            },
            _removeNodeIfContentIsEmpty: function(x) {
                var y = (x && (x.textContent || x.innerText));
                if (x && y && (y.trim() === "")) {
                    v.remove(x)
                }
            },
            _pasteHtmlAndText: function(C, B, A, E) {
                if (!B) {
                    return
                }
                var y = this.getProcessor();
                ...
                var G;
                if (A === c && E.nodeType === e) {
                    G = this.divideTree(E, B);
                    this._removeNodeIfContentIsEmpty(G.previousNode);
                    this._removeNodeIfContentIsEmpty(G.nextNode);
                    B = y.createGoogRange();
                    B.insertNode(D);
                    this.removeDummyText()
                } else {
                ...
                C.each(function(H) {
                    ...
                    B = y.createGoogRangeFromNodes(D, F, D, F);
                    B.select();
                    if (H.nodeType === w) {
                        var I = y.create("p");
                        I.appendChild(H);
                ...
                var x = v.bottom(D);
                if (x == D) {
                    x = D.childNodes[D.childNodes.length - 1]
                }
                v.unwrap(D);
                if (v.isElement(x)) {
                    var z = y.doc.createTextNode(g.__WORD_JOINER);
                    v.insertAt(z, x);
                    v.insertAt(x, z);
                    B = y.createGoogRangeFromNodes(z, 0, z, v.getLength(z));
                    B.removeContents()
                } else {
                    B = y.createGoogRangeFromNodes(x, v.getLength(x), x, v.getLength(x))
                }
                B.select();
                return B
            },
            _getAnchorNodeByRange: function(y) {
                if (!y) {
                    return
                }
                var z = y.getFocusNode();
                while (z) {
                    var x = z.parentNode;
                    if (v.kindOf(x, "p,div")) {
                        z = x;
                        ...
                        if (v.isBody(x) || v.kindOf(x, "%innergroup") || v.isBlock(x)) {
                            break
                        } else {
                            if (v.kindOf(x, "%text,%inline")) {} else {
                                break
                            }
                        }
                    }
        ...
        g.Paste.I.ProcessorBETATridentLegacy = g.Mixin.create({
            cleanPasteHtml: function(x) {
                return x
            },
            _pasteTextOnly: function(x, A) {
                var z = this.getProcessor();
                var y = z.doc.selection.createRange();
                y.pasteHTML(x[0].nodeValue)
            },
            _pasteHtmlAndText: function(y, z, x, A) {
                var B = this.getProcessor();
                if (x === c && A.nodeType === e) {
                    var C = this.divideTree(A, z);
                    z = B.createGoogRange();
                    this._removeNodeIfContentIsEmpty(C.previousNode);
                    this._removeNodeIfContentIsEmpty(C.nextNode)
                }
                y.each(function(D) {
                    z.collapse(false);
                    if (D.nodeType === w) {
        ...
        g.Paste.Helper = g.Class.create({
            $mixins: [g.Paste.I.ProcessorBETA, g.Paste.isMSSelection ? g.Paste.I.ProcessorBETATridentLegacy : {}]
        });
        g.Paste.I.CleanerStandard = g.Mixin.create({
            $const: {
            ...
            execute: function(z) {
                var x = this;
                var y = z;
                y = this.defaultFilterBegin(y);
                y = this.filterOptional(y);
                for (var A in this.filters) {
                    var B = this.filters[A];
                    if (this.filters.hasOwnProperty(A) && typeof B === "function") {
                        y = B.call(x, y)
                    }
                }
                y = this.defaultFilterEnd(y);
                return y
            },
            defaultFilterBegin: function(x) {
                x = x.replace(/>\s+</g, "><");
                x = x.replace(/(<[a-z]+[^>]*>)/gi, "\n$1");
                x = x.replace(/\n<head>.*<\/head>/gi, "");
                x = x.replace(/<\/?(html|body|meta)[^>]*>/gi, "");
                x = x.replace(/<!--/g, "\n<!--");
                x = x.replace(/\n<!--.*-->/g, "");
                x = x.replace(/<p[^>]*>/gi, "<p>");
                x = x.replace(/<(font|span[^>]*)>/gi, "<$1>");
                x = x.replace(/\n<(font|span)[^>]*>\s*<\/\1>/gi, "");
                x = x.replace(/(\d+)?\.(\d+)([a-z]+)/gi, function(y, C, A, z) {
                    C = C || "0";
                    var B = Math.round(parseFloat(C + "." + A));
                    return B + z
                });
                return x
            },
            defaultFilterEnd: function(x) {
                return x
            },
            filterOptional: function(x) {
                x = x.replace(/<p>&nbsp;<\/p>/gi, v.EMPTY_PARAGRAPH_HTML);
                return x
            },
            addFilter: function(x, y) {
                this.filters[x] = y
            },
        ...
        g.Paste.I.CleanerTridentStandard = g.Mixin.create({
            $const: {
                __Identity: "cleaner-trident-standard"
            },
            filterOptional: function(x) {
                x = x.replace(/<p><br[^>]*><\/p>/gi, v.EMPTY_PARAGRAPH_HTML);
                return x
            }
        });
        g.Paste.I.CleanerTridentLegacy = g.Mixin.create({
            $const: {
        ...
        g.Paste.Cleaner = g.Class.create({
            $mixins: [g.Paste.I.CleanerStandard, (t.msie && g.Paste.isMSSelection ? g.Paste.I.CleanerTridentLegacy : {}), (t.msie && !g.Paste.isMSSelection ? g.Paste.I.CleanerTridentStandard : {})]
        });
        g.Paste.I.Standard = g.Mixin.create({
            $const: {
            ...
            bindEvents: function() {
                var x = this;
                this.canvas.observeJob(g.Ev.__CANVAS_PANEL_PASTE, function(y) {
                    if (x.isEnable) {
                        if (!x.isPasteProcessing) {
                            x.onNativePaste(y)
                        } else {
                            x.preventPasteDefault(y)
                        }
                    }
                })
            },
            onNativePaste: function(x) {
                if (!this.canvas.isWYSIWYG()) {
                    return c
                }
                var y = this.getPasteDummy();
                if (y) {
                    this.preventPasteDefault(x);
                    return c
                }
                var z = x.clipboardData;
                if (z && z.getData) {
                    return this.pasteByClipboardGetData(x)
                } else {
                    return this.pasteByRedirection(x)
                }
            },
            switchMode: function(x) {
                switch (x) {
                    case g.Paste.MODE_HTML:
                        this.isTextOnly = c;
                        this.isEnable = u;
                        break;
                    case g.Paste.MODE_TEXT:
                        this.isTextOnly = u;
                        this.isEnable = u;
                        break;
                    case g.Paste.MODE_OFF:
                    default:
                        this.isTextOnly = c;
                        this.isEnable = c
                }
            ...
            getMode: function() {
                if (!this.isTextOnly && this.isEnable) {
                    return g.Paste.MODE_HTML
                } else {
                    if (this.isTextOnly && this.isEnable) {
                        return g.Paste.MODE_TEXT
                    } else {
                        return g.Paste.MODE_OFF
                    }
                }
            },
            getDocument: function() {
                if (!this.doc) {
                    this.doc = this.canvas.getPanel(g.Canvas.__WYSIWYG_MODE).getDocument()
                }
                return this.doc
            },
            ...
            preventPasteDefault: function(x) {
                if (x.preventDefault) {
                    x.preventDefault();
                    x.stopPropagation()
                } else {
            ...
            pasteByClipboardGetData: function(A) {
                this.preventPasteDefault(A);
                this.isPasteProcessing = u;
                var B = A.clipboardData;
                var z = $A(B.types);
                var y = "";
                var x = this;
                if (!this.isTextOnly && z.include("text/html")) {
                    y = B.getData("text/html")
                } else {
                    if (z.include("text/plain")) {
                        y = B.getData("text/plain")
                    } else {
                        y = "???"
                    }
                }
                ...
                this.saveRange();
                this.restoreRange();
                this.pasteHTML(this.cleaner.execute(y));
                this.isPasteProcessing = c
            },
            pasteByRedirection: function(y) {
                var x = this;
                this.isPasteProcessing = u;
                this.removeRangeContents();
                this.saveRange();
                var z = this.createPasteDummy();
                this.appendPasteDummy(z);
                this.setRangeToDummy(z);
                this.execPasteCommand();
                setTimeout(function() {
                    x.restoreRange();
                    x.copyContentToOriginalRange(z);
                    x.isPasteProcessing = c
                }, 1)
            },
            copyContentToOriginalRange: function(x) {
                var z = x || this.getPasteDummy();
                if (!z) {
                    throw new Error("paste-dummy node is not found");
                    return
                }
                var y = this.isTextOnly ? z.innerText : this.cleaner.execute(z.innerHTML);
                this.pasteHTML(y)
            },
            createPasteDummy: function(x) {
                x = x || "div";
                var y = this.getDocument().createElement(x);
                y.id = "pasteDummy";
                y.innerHTML = g.__WORD_JOINER;
            ...
            appendPasteDummy: function(x) {
                var y = this.getDocument();
                y.body.appendChild(x)
            },
            removePasteDummy: function() {
                var x = this.getPasteDummy();
                if (x) {
                    v.remove(x);
                    x = i
                }
            },
            setRangeToDummy: function(x) {
                var A = this.getDocument();
                var z = x || this.getPasteDummy();
                var y = this.canvas.getProcessor();
                z.focus();
                y.createGoogFromNodeContents(z).select()
            },
            ...
            removeRangeContents: function() {
                var x = this.canvas.getProcessor().createGoogRange();
                if (x) {
                    x.removeContents()
                }
            },
            saveRange: function() {
                var x = this.canvas.getProcessor().createGoogRange();
                if (x) {
                    this.savedCaret = x.saveUsingCarets()
                }
            },
            ...
            pasteHTML: function(y) {
                var x = this;
                this.canvas.execute(function(z) {
                    x.processor = z;
                    x.helper.pasteContent(y);
                    x.removePasteDummy()
                })
            }
        });
        g.Paste.I.TridentStandard = g.Mixin.create({
            $const: {
            ...
            createPasteDummy: function(x) {
                ...
                y.style.height = "200px";
                y.style.background = "gray";
                y.setAttribute("contentEditable", u);
                ["beforedeactivate", "focusin", "focusout", "paste"].each(function(z) {
                    t.observe(y, z, function(A) {
                        t.stopPropagation(A)
                    })
                });
                return y
        ...
        g.Paste.I.TridentLegacy = g.Mixin.create({
            $const: {
            ...
            appendPasteDummy: function(x) {
                var y = this.getDocument();
                y.body.parentNode.appendChild(x)
            },
            pasteByRedirection: g.Paste.I.TridentStandard.pasteByRedirection,
            setRangeToDummy: function(y) {
                var z = y || this.getPasteDummy();
                var x = z.createTextRange();
                x.moveToElementText(z);
                x.collapse(u);
                x.moveStart("character", 0);
                x.moveEnd("character", 0);
                x.execCommand("paste", i, c)
            },
            execPasteCommand: function() {}
        });
        g.Paste.I.GeckoForWindows = g.Mixin.create({
            $const: {
        ...
        g.Paste.Paster = g.Class.create({
            $mixins: [g.Paste.I.Standard, (t.msie && g.Paste.isMSSelection ? g.Paste.I.TridentLegacy : {}), (t.msie && !g.Paste.isMSSelection ? g.Paste.I.TridentStandard : {}), (t.os_win && t.gecko ? g.Paste.I.GeckoForWindows : {})]
        });
        g.install("editor.getPaster", function(B, C, E, z, y) {
            var A = new g.Paste.Cleaner(B, z);
            var D = new g.Paste.Helper(B, z);
            var x = new g.Paste.Paster(B, z, A, D);
            B.getPaster = function() {
                return x
            };
            B.getPasteCleaner = function() {
                return x.cleaner
            };
            B.getPasteProcessor = function() {
                return D
            }
        })
    }();
    g.register("filter > paste", function(z, A, B, w, e) {
        if (!(t.msie && !g.Paste.isMSSelection)) {
            return
        }
        ...
        function y(E) {
            ...
            var D = document.getElementById("pasteDummy");
            if (D && v.findAncestor(D, function(G) {
                    return G === F
                }, function(G) {
                    return v.isBody(G) || G.parentNode == i
                })) {
                v.remove(D)
            }
            var C = F.innerHTML;
        ...
        var x = z.getDocParser();
        x.registerFilter("filter/paste", {
            "source@load": function(C) {
                return C
            },
            "html@load": function(C) {
                return C
            },
            source4save: function(C) {
                return C
            },
            html4save: function(C) {
                return y(C)
            },
            text4save: function(C) {
                return C
            },
            html2text: function(C) {
                return y(C)
            },
            source2text: function(C) {
                return C
            },
            source2html: function(C) {
                return C
            },
            html2source: function(C) {
                return y(C)
            }
        })
    });
    ...
    g.I.History.Webkit = {
        ...
        restoreRange: function(F) {
            var D = this.canvas.getCurrentPanel().getWindow();
            var H = D.document;
            var E = H.body;
            var e = 0,
                B = H.createRange();
            ...
            while (!G && (x = A.pop())) {
                if (x.nodeType == 3) {
                    var C = e + x.length;
                    if (!y && F.start >= e && F.start <= C) {
                        B.setStart(x, F.start - e);
                        y = true
                    }
                    if (y && F.end >= e && F.end <= C) {
                        B.setEnd(x, F.end - e);
                        G = true
                    }
                    e = C
    ...
    (function(w) {
        ...
        w.Canvas = w.Class.create({
            ...
            changeMode: function(z) {
                ...
                if (this._isForceTextMode() && D == w.Canvas.__TEXT_MODE) {
                    return
                }
                var A = this.panels[D];
                var B = this.panels[z];
            ...
            onKeyDown: function(A) {
                ...
                var z = null;
                if (A.keyCode == w.__KEY.BACKSPACE && y && C.isCollapsed() && (z = v.prevNodeUntilTagName(y.node, y.offset, "table")) && v.isTagName(z, "table")) {
                    t.stop(A);
            ...
            onMouseOver: (function() {
                var y = function(z) {
                    try {
                        this.fireMouseover(t.element(z));
                        this.fireJobs(w.Ev.__CANVAS_PANEL_MOUSEOVER, z)
                    } catch (A) {}
                };
                return t.msie_nonstd ? y : t.throttle(y, 50)
            })(),
            onMouseMove: (function() {
                var y = function(z) {
                    try {
                        this.fireJobs(w.Ev.__CANVAS_PANEL_MOUSEMOVE, z)
                    } catch (A) {}
                };
                return t.msie_nonstd ? y : t.throttle(y, 50)
            })(),
            onMouseOut: (function() {
                var y = function(z) {
                    try {
                        this.fireJobs(w.Ev.__CANVAS_PANEL_MOUSEOUT, z)
                    } catch (A) {}
                };
                return t.msie_nonstd ? y : t.throttle(y, 50)
            })(),
            ...
            onDragOver: function(y) {
                this.fireJobs(w.Ev.__CANVAS_PANEL_DRAGOVER, y)
            },
            onDragEnter: function(y) {
                this.fireJobs(w.Ev.__CANVAS_PANEL_DRAGENTER, y)
            },
            onDragLeave: function(y) {
                this.fireJobs(w.Ev.__CANVAS_PANEL_DRAGLEAVE, y)
            },
            onDrop: function(y) {
                this.fireJobs(w.Ev.__CANVAS_PANEL_DROP, y)
            },
            onScroll: (function() {
                var y = function(z) {
                    this.fireJobs(w.Ev.__CANVAS_PANEL_SCROLLING, z)
                };
                return t.msie_nonstd ? y : t.throttle(y, 50)
            })(),
            onPaste: function(y) {
    ...
    g.module("make getter for 'iframeheight' and 'iframetop' size", function(y, A, B, x) {
        var C = 0;
        var e = 0;

        function z() {
            var E = x.getPanel(g.Canvas.__WYSIWYG_MODE);
            C = E.getPanelHeight().parsePx();
            var D = v.getPosition(E.el);
            e = D.y
        }
        x.observeJob(g.Ev.__CANVAS_HEIGHT_CHANGE, function(D) {
            z()
        });
        x.observeJob(g.Ev.__CANVAS_FULL_SCREEN_CHANGE, function() {
            z()
        });
        x.observeJob(g.Ev.__CANVAS_NORMAL_SCREEN_CHANGE, function() {
            z()
        });
        x.observeJob("canvas.apply.background", function() {
            z()
        });
        x.observeJob("canvas.apply.letterpaper", function() {
            z()
        });
        x.reserveJob(g.Ev.__IFRAME_LOAD_COMPLETE, function() {
            z()
        }, 300);
        var w = y.getAttachBox();
        w.observeJob(g.Ev.__ATTACHBOX_FULLSCREEN_SHOW, function() {
            z()
        });
        w.observeJob(g.Ev.__ATTACHBOX_FULLSCREEN_HIDE, function() {
            z()
        });
        t.observe(h, "resize", function() {
            z()
        });
    ...
    g.module("synchronize the font style when caret is in end of paragraph", function(w, x, y, e) {
        t.gecko && e.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, function(I) {
            if (e.isWYSIWYG()) {
                var C = I.target;
                var D = C instanceof HTMLParagraphElement;
                var z = C instanceof HTMLHtmlElement;
                if (!D && !z) {
                    return
                }
                ...
                var K = I.pageX,
                    H = I.pageY;
                var G = A.doc.caretPositionFromPoint(K, H);
                var B = G && G.offsetNode;
                var E = B && v.descendants(B, "#text");
                if (!E || !E.length) {
                    return
                }
                var F = E[E.length - 1];
                if (F) {
                    var J = A.createGoogRangeFromNodes(F, F.length, F, F.length);
                    J.select()
                }
            }
        })
    });
    g.module("apply respectVisibilityInDesign for old IE", function(x, z, A, w, e) {
        var C = (t.msie && (t.msie_docmode < 9));
        C && w.observeJob(g.Ev.__CANVAS_MODE_CHANGE, function(D, E) {
            y()
        });
        C && w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(D) {
            y()
        });
        var B = "RespectVisibilityInDesign";

        function y() {
            if (w.isWYSIWYG()) {
                var D = w.getProcessor();
                var F = D.doc.queryCommandState(B);
                var E = w.config.respectVisibilityInDesign;
                if (F != E) {
                    D.doc.execCommand(B, false, E)
                }
            }
        }
    });
    ...
    (function() {
        g.WysiwygIframeLoader = g.Class.create({
            ...
            reloadUsingCatalyst: function(F) {
                var C = this;
                h.__tx_wysiwyg_iframe_load_complete = function() {
                    C.loadLocalIframe(F, "")
                };
                if (!this.iframeUrl) {
                    var E = this.getIframePagePath();
                    var B = this.doctype;
                    switch (B) {
                        case "edge":
                        case "loose":
                        case "strict":
                            this.iframeUrl = E + "trex/iframe_loader_catalyst_" + B + ".html";
                            break;
                        default:
                            this.iframeUrl = E + "trex/iframe_loader_catalyst.html"
                    }
                }
                var D = (document.location.hostname != document.domain);
                if (D) {
        ...
        g.Canvas.WysiwygPanel = g.Class.create({
            ...
            makeEditable: function() {
                ...
                if (this.wysiwygDoc.body.contentEditable) {
                    ...
                    if (t.gecko) {
                        this.wysiwygDoc.execCommand("enableInlineTableEditing", c, c);
                        this.wysiwygDoc.execCommand("enableObjectResizing", c, c)
                    }
                } else {
                    var z = this;
                    setTimeout(function() {
                        try {
                            ...
                            if (t.gecko) {
                                ...
                                z.wysiwygDoc.execCommand("enableObjectResizing", c, c)
                            }
                        } catch (A) {
            ...
            setPanelHeight: function(z) {
                var B = this;

                function C(E) {
                    var D = B.wysiwygWindow.document.body;
                    var F = parseInt(t.getStyle(D, "margin-top")) + parseInt(t.getStyle(D, "padding-top"));
                    var G = parseInt(t.getStyle(D, "margin-bottom")) + parseInt(t.getStyle(D, "padding-bottom"));
                    E = parseInt(E);
                    D.style.height = (E - F - G).toPx()
                }
                ...
                function A(E) {
                    ...
                    try {
                        ...
                        setTimeout(A.bind(this, E - 1), 30)
                    }
                }
                A(10);
                B.$super.setPanelHeight(z)
            },
    ...
    g.I.Selection.TridentStandard = {
        getControl: function() {
            ...
            var y, z;
            z = v.isElement(y = A.anchorNode) ? A.anchorOffset : v.isElement(y = A.focusNode) ? A.focusOffset - 1 : i;
            if (z !== i) {
                var x = y.childNodes[z];
            ...
            var w = v.previous(A.focusNode);
            var e = v.next(A.anchorNode);
            if (w == e) {
                return (v.kindOf(w, "%control") && w) || v.first(w, "%control")
            } else {
                return null
            }
        },
        selectControl: function(w) {
            ...
            if (this.doc.body.createControlRange) {
                e = this.doc.body.createControlRange();
                e.add(w);
                e.select()
            } else {
                e = this.createRange();
    ...
    g.Canvas.TextAreaProcessor = g.Class.create({
        ...
        focusOnBottom: function() {
            var w = this.el;
            w.focus();
            var e = w.value.length;
            this._selectCharacter(e, e);
        ...
        _selectCharacter: function(w, y) {
            var e = this.el;
            if (e.setSelectionRange) {
                e.select();
                e.setSelectionRange(w, y)
            } else {
    ...
    g.I.Processor.Standard = {
        ...
        pasteNode: function(A, z, C) {
            ...
            if (z) {
                ...
                this.execWithMarker(function(E) {
                    e = v.divideParagraph(E.endMarker);
                    var G = v.kindOf(e, "p,li,dd,dt,h1,h2,h3,h4,h5,h6");
                    if (G) {
                        y = v.previous(e);
                        w = v.clone(e)
                    } else {
                        e = B.newNode("p");
                        v.insertAt(e, E.endMarker);
                        w = B.newNode("p")
                    }
                    v.insertAt(w, e);
                    A.each(function(I) {
                    ...
                    if (A.length == 1) {
                        var F = A[0];
                        var H = v.kindOf(F, "table,hr,blockquote,pre,h1,h2,h3,h4,h5,h6,div");
                        var D = v.isTagName(w, "p");
                        if (H && D) {
                            F.style.marginLeft = w.style.marginLeft;
                            v.unwrap(w)
                        }
                    }
                });
        ...
        wrap: function(y, w, x) {
            ...
            x = x || {};
            var z = v.wrap(this.create(w, x), y);
            if (t.msie && !v.nextContent(z)) {
                var A = this.doc.createElement("p");
                A.innerHTML = v.EMPTY_BOGUS;
        ...
        createGoogFromNodeContents: function(w, e) {
            return d.dom.Range.createFromNodeContents(w, e)
        },
        ...
        moveSelection: function(w, F) {
            var D = this.doc;
            var C = this.win;
            var z;
            var E;
            w -= C.pageXOffset || D.documentElement.scrollLeft;
            F -= C.pageYOffset || D.documentElement.scrollTop;
            if (D.caretPositionFromPoint) {
                z = D.createRange();
                E = D.caretPositionFromPoint(w, F);
                z.setStart(E.offsetNode, E.offset);
                z.setEnd(E.offsetNode, E.offset)
            } else {
                if (D.caretRangeFromPoint) {
                    z = D.caretRangeFromPoint(w, F)
                } else {
                    try {
                        z = D.body.createTextRange() || D.createRange();
                        z.moveToPoint(w, F);
                        z.select()
                    } catch (B) {}
                    return
    ...
    g.module("bind iframe activate or deactivate event", function(w, x, y, e) {
        e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(z) {
            ...
            t.observe(z, "beforedeactivate", function(C) {
                try {
                    var B = A.getRange();
    ...
    g.module("save range when keyup or mouseup event ", function(w, x, y, e) {
        e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(z) {
            var A = e.getProcessor(g.Canvas.__WYSIWYG_MODE);
            var C = t.debounce(B, 200);

            function B() {
                var D = A.createGoogRange();
                if (D) {
                    A.savedRange = D
                }
            }
            t.observe(z, "deactivate", function(D) {
                B()
            });
            t.observe(z, "mouseup", function(D) {
                B()
            });
            t.observe(z, "keydown", function(D) {
                C()
            })
        })
    });
    ...
    g.Attachment = g.Class.draft({
        ...
        register: function() {
            ...
            if (this.canvas.isWYSIWYG()) {
                ...
                var B = this.dispHtml;
                var y = "img";
                var A = this.matchRegexStartTag;
                var w = B.match(A);
                if (w && w[1]) {
                    y = w[1]
                }
                if (this.objectStyle) {
                    var C = new RegExp("<" + y + " ", "i");
                    B = B.replace(C, "<" + y + ' style="' + g.Util.toStyleString(this.objectStyle) + '" ')
                }
                if (this.objectAttr) {
                    B = B.replace(C, "<" + y + " " + g.Util.toAttrString(this.objectAttr) + " ")
                }
        ...
        updateEntryElement: function(e) {
            if (!e) {
                return
            }
            var w = b.createElement("div");
            w.innerHTML = this.dispHtml;
            e.innerHTML = v.first(w).innerHTML
        }
    });
    ...
    g.module("attachbox.updateCapacity on Trex.Ev.__ATTACHBOX_SHOW", function(w) {
        var e = w.getAttachBox();
        e.observeJob(g.Ev.__ATTACHBOX_SHOW, function() {
            e.updateCapacity()
        })
    });
    ...
    g.I.ButtonFontTool = g.Mixin.create({
        ...
        queryCurrentStyle: function(w) {
            ...
            var x = e.canvas.query(function(z) {
                var C = e.getQueryCommandName();
                var y = 20;
                var A = (t.gecko && t.gecko_ver < y);
                if (C && !t.opera && !A) {
                    return z.queryCommandState(C)
                } else {
                    var B = e.findQueryingNode(w);
                    return !!B && e.isStyleApplied(B)
                }
            });
            return x
        },
    ...
    p.addTool("fontsize", {
        ...
        status: u,
        options: [{
            label: "\A\B\C\D\E\F\G (8pt)",
            title: "8pt",
            data: "8pt",
            klass: "tx-8pt"
        }, {
            label: "\A\B\C\D\E\F\G (9pt)",
            title: "9pt",
            data: "9pt",
            klass: "tx-9pt"
        }, {
            label: "\A\B\C\D\E\F\G (10pt)",
            title: "10pt",
            data: "10pt",
            klass: "tx-10pt"
        }, {
            label: "\A\B\C\D\E\F\G (11pt)",
            title: "11pt",
            data: "11pt",
            klass: "tx-11pt"
        }, {
            label: "\A\B\C\D\E\F\G (12pt)",
            title: "12pt",
            data: "12pt",
            klass: "tx-12pt"
        }, {
            label: "\A\B\C\D\E\F\G (14pt)",
            title: "14pt",
            data: "14pt",
            klass: "tx-14pt"
        }, {
            label: "\A\B\C\D\E\F\G (18pt)",
            title: "18pt",
            data: "18pt",
            klass: "tx-18pt"
        }, {
            label: "\A\B\C\D\E (24pt)",
            title: "24pt",
            data: "24pt",
            klass: "tx-24pt"
        }, {
    ...
    g.Tool.Underline = g.Class.create({
        ...
        $extend: g.Tool,
        $mixins: [g.I.FontTool, g.I.ButtonFontTool, g.I.WrappingDummyFontTool, (t.gecko ? g.I.Tool.QueryStyle.Gecko : g.I.Tool.QueryStyle.Standard)],
        getRelatedCssPropertyNames: function() {
        ...
        isStyleApplied: function(w) {
            var e = "u";
            return this.queryNodeStyle(w, this.getCssPropertyName(), this.getQueryCommandName(), e)
        }
    });
    p.addTool("italic", {
        wysiwygonly: u,
    ...
    g.Tool.Indent = g.Class.create({
        ...
        createHandlers: function() {
            ...
            var y = B.connect([new B(z.And(z.HeadOfParagraph, z.ListItem), w.IndentListItem), new B(z.ChildOfLastTableCell, w.GoToBelowTable), new B(z.ChildOfTableCell, w.GoToNextCell), new B(z.AlwaysTrue, w.IndentBlockNode)]);
        ...
        g.Tool.Indent.Helper = {
            findBlocksToIndentFromRange: function(z, C, E) {
                ...
                if (C.isCollapsed()) {
                    ...
                    var x = (D && D.tagName == "P" && D.firstChild == A && D.lastChild == y);
                    if (x) {
                        C.stuffNode(D)
                    }
                    E.restoreInternal();
    ...
    g.I.AlignExecution = g.Mixin.create({
        executeAlignImageMode: function(x) {
            ...
            var w = x.getControlByAreaSelection();
            if (!w) {
                return
            }
            x.apply(w, z);
        ...
        executeAlignTableMode: function(e) {
            var w = e.getControlByAreaSelection();
            if (!w) {
                return
            }
            e.apply(w, this.constructor.__TableModeProps)
        },
        ...
        queryImageFloat: function(w) {
            var e = w.getControlByAreaSelection();
            if (e) {
        ...
        executeAlign: function(w) {
            ...
            if (x == "tableCell") {
                ...
                if (x == "image") {
                    ...
                    if (x == "table") {
                        e.executeAlignTableMode(w)
                    } else {
                        e.executeAlignTextMode(w)
                    }
                }
            }
            if (!w.getAreaSelection) {
                return
            }
            var y = w.getAreaSelection();
            y.update()
        },
        getAlignMode: function(w) {
            var e = (w.table) ? w.table.getTdArr() : [];
            var x = w.getControlByAreaSelection();
            if (e.length > 0) {
                return "tableCell"
            } else {
                if (v.kindOf(x, "table")) {
        ...
        queryCurrentStyle: function(e) {
            var w = this.getAlignMode(e);
            if (w == "table") {
                return this.queryTableMode(e)
            } else {
                if (w == "image") {
        ...
        queryTableMode: function(w) {
            var e = w.getControlByAreaSelection();
            return v.getAttribute(e, "align") == this.constructor.__TableModeProps.align
        },
                ...
                A.execute(function(C) {
                    ...
                    if (D == "image") {
                        ...
                        if (D == "text") {
                            ...
                            if (D == "table") {
                                B.fireJobs(g.Ev.__CMD_ALIGN_TABLE_LEFT)
                            }
                        }
                    }
                });
                ...
                A.execute(function(C) {
                    ...
                    if (D == "image") {
                        ...
                        if (D == "text") {
                            ...
                            if (D == "table") {
                                B.fireJobs(g.Ev.__CMD_ALIGN_TABLE_CENTER)
                            }
                        }
                    }
                });
                ...
                B.execute(function(D) {
                    ...
                    if (E == "image") {
                        ...
                        if (E == "text") {
                            ...
                            if (E == "table") {
                                C.fireJobs(g.Ev.__CMD_ALIGN_TABLE_FLOAT_LEFT)
                            }
                        }
                    }
                });
                ...
                B.execute(function(D) {
                    ...
                    if (E == "image") {
                        ...
                        if (E == "text") {
                            ...
                            if (E == "table") {
                                C.fireJobs(g.Ev.__CMD_ALIGN_TABLE_FLOAT_RIGHT)
                            }
                        }
                    }
                });
    ...
    p.addTool("insertcells", {
        ...
        status: u,
        options: [{
            label: "Insert the top",
            title: "Insert the top",
            data: "addRowUpper",
            ...
            label: "Insert the left",
            title: "Insert the left",
            data: "addColLeft",
    ...
    p.addTool("cellsoutline", {
        ...
        options: [{
            ...
            label: "Outside the borders",
            title: "Outside the borders",
            data: "out",
            klass: "tx-cellsoutline-2"
        }, {
            label: "The inner border",
            title: "The inner border",
            data: "in",
    ...
    p.addTool("tableresize", {
        wysiwygonly: u,
        sync: c,
        status: u
    });
    g.Tool.TableResize = g.Class.create({
        $const: {
        ...
        oninitialized: function() {
            ...
            this.weave.bind(this)(e.button, new g.Menu.TableResize(this.menuCfg), x)
        }
    });
    g.MarkupTemplate.add("menu.tableresize", ['<div class="tx-menu-inner">', '<p class="desc_cellsize">\uc120\ud0dd\ub41c \ud45ccell \ud06c\uae30\ub97c \uc785\ub825\ud574\uc8fc\uc138\uc694.</p>', "<div>", '<label for="cellWidth">@tableresize.width</label>', '<input type="text" name="cellWidth" id="cellWidth" class="inp_cellw" /> px', "</div>", "<div>", '<label for="cellHeight">@tableresize.height</label>', '<input type="text" name="cellHeight" id="cellHeight" class="inp_cellh" /> px', "</div>", '<div class="wrap_btn">', '<img src="@tableresize.confirm.image" class="tx-menu-btn" alt="\ud655\uc778" />', '<img src="@tableresize.cancel.image" class="tx-menu-btn" alt="\ucde8\uc18c" />', "</div>", "</div><!-- //tx-menu-inner -->"].join("\n"));
    g.Menu.TableResize = g.Class.create({
        $extend: g.Menu,
        ongenerated: function() {
            var x = this.elMenu;
            g.MarkupTemplate.get("menu.tableresize").evaluateToDom({}, x);
            var e = this;
            var w = v.collectAll(x, "input");
            var y = v.collectAll(x, "img");
            t.observe(y[0], "click", function(z) {
                var A = e._isValidation(w[0].value) && e._isValidation(w[1].value);
                if (!A) {
                ...
                this.onSelect(z, {
                    width: parseInt(w[0].value),
                    height: parseInt(w[1].value)
                });
                t.stop(z)
            }.bind(this));
            t.observe(y[1], "click", function() {
                this.onCancel()
            }.bindAsEventListener(this))
        },
        _isValidation: function(e) {
            return e > 0
        },
        onregenerated: function() {
            var y = this.elMenu;
            var e = Editor.getCanvas().getProcessor();
            var z = e.table.getTdArr()[0];
            var x = v.collectAll(y, "input");
            if (!z) {
                x[0].value = "";
                x[1].value = ""
            } else {
                var w = g.TableUtil.getCellOffset(z);
                x[0].value = w.width;
                x[1].value = w.height
            }
        }
    });
    p.addTool("tablevalign", {
        wysiwygonly: u,
        sync: c,
        status: u,
        options: [{
            label: "\uc0c1\ub2e8\ub9de\ucda4",
            data: "TOP",
            klass: "cell_ico cell_top"
        }, {
            label: "\uc911\uac04\ub9de\ucda4",
            data: "MIDDLE",
            klass: "cell_ico cell_mid"
        }, {
            label: "\ud558\ub2e8\ub9de\ucda4",
            data: "BOTTOM",
            klass: "cell_ico cell_bot"
        }]
    });
    g.Tool.TableValign = g.Class.create({
        $const: {
        ...
        oninitialized: function() {
            ...
            this.button = new g.Button(this.buttonCfg);
            var x = function(y) {
                w.getProcessor().table.execute(function() {
                    var z = w.getProcessor().table.getTdArr();
                    z.each(function(A) {
                        A.style.verticalAlign = y.toLowerCase()
                    })
                })
            };
            this.weave.bind(this)(e.button, new g.Menu.Tablevalign(this.menuCfg), x)
        }
    });
    g.MarkupTemplate.add("menu.tablevalign", '<ul class="tx-menu-list list_valign" unselectable="on">#{items}</ul>');
    g.Menu.Tablevalign = g.Class.create({
        $extend: g.Menu,
        generate: function() {
            var x = this.config;
            var e = this.getValidOptions(x);
        ...
        generateList: function(z) {
            var w = g.MarkupTemplate.get("menu.tablevalign").evaluateAsDom({
                items: this.generateListItem(z)
            });
            var y = v.collectAll(w, "li a");
            for (var e = 0; e < z.length; e++) {
    ...
    j.addMsg({
        ...
        "@insertlink.title": "Please enter the URL address<br>of the selected take part.",
        "@insertlink.onclick.target": "When clicked<br>",
        "@insertlink.target.blank": "New Window<br>",
                ...
                if (A.isWYSIWYG()) {
                    if (B) {
                        A.execute(function(C) {
                            ...
                            if (C.findNode("a")) {
                                E = C.findNode("a");
                                v.applyAttributes(E, G)
                            } else {
                                if (C.hasControl()) {
                                    D = C.controls(function() {
                                        return "img"
                                    });
                                    v.wrap(C.create("a", G), D)
                                } else {
                                    if (C.isCollapsed()) {
                                        E = C.create("a", G);
                                        var F = C.doc.createTextNode(B.link);
                                        E.appendChild(F);
                                        C.pasteNode(E, c)
                                    } else {
                                        ...
                                        D.each(function(H) {
                                            if (v.hasUsefulChildren(H, u)) {
                                                if (v.kindOf(H, "a")) {
                                                    v.applyAttributes(H, G)
                                                } else {
                                                    if (v.kindOf(H, "img")) {
                                                        v.wrap(C.create("a", G), [H])
                                                    } else {
                                                        var J = v.getStyleText(H);
                                                        var K = v.collectAll(H, "a");
                                                        K.each(function(L) {
                                                            v.moveChildToParent(L);
                                                            v.remove(L)
                                                        });
                                                        var I = C.create("a", G);
                                                        v.setStyleText(I, J);
    ...
    j.addMsg({
        "@richtextbox.add": "add",
        "@richtextbox.sub": "sub",
        "@richtextbox.alert": "Only numbers from 1 to 20 can be entered.",
        "@richtextbox.bg.color": "bg color",
        "@richtextbox.border.color": "bd color",
        "@richtextbox.border.style": "bd style",
        "@richtextbox.border.width": "bd width"
    });
    ...
    g.Tool.Table = g.Class.create({
        ...
        oninitialized: function(w) {
            ...
            var y = this.canvas;
            var x = this.handler = function(z) {
                y.execute(function(C) {
                    var A = "100%";
                    C.executeUsingCaret(function(F, G) {
                        var E = G.getCaret(c);
                        if (!v.ancestor(E, "table")) {
                            A = e.getDefaultTableWidth()
                        }
                    });
                    var D = e.makeEmptyTable(z.row, z.col, A);
                    var B = C.pasteContent(D, u);
                    C.bookmarkInto(B);
        ...
        makeEmptyTable: function(F, e, C) {
            var E = [];
            E.push('<table class="' + g.Tool.Table.__DEFAULT_TABLE_CLASS + '"');
            C && E.push(' width="' + C + '"');
            ...
            var B = this.getDefaultCellWidth(e, C),
                A = this.getDefaultCellHeight(F);
        ...
        getDefaultCellWidth: function(x, e) {
            var w;
            e = e || "100%";
            if (e.toString().indexOf("%") !== -1) {
                w = (100 / x) + "%"
            } else {
                w = parseInt(parseInt(e, 10) / x, 10);
                if (isNaN(w)) {
                    w = 0
                }
                w = w.toPx()
        ...
        getDefaultCellHeight: function(e) {
            return g.Tool.Table.__DEFAULT_TABLE_CELL_HEIGHT.toPx()
        },
        getDefaultTableWidth: function() {
            var e = this.config.tableWidth;
            if (!e) {
                e = this.getCanvasInnerWidth()
            }
            return e
        },
        getCanvasInnerWidth: function() {
            var e = this.canvas.getSizeConfig().contentPadding || 8;
            return (this.canvas.getSizeConfig().contentWidth || 600) - e * 2 - 20
        }
    });
    ...
    j.addMsg({
        ...
        "@table.title.setDirectly": "Table settings directly",
        "@table.title.row": "Number of Columns",
        "@table.title.col": "Number of Rows"
    });
    g.MarkupTemplate.add("menu.table.direct", ["<div>@table.title.setDirectly</div>", '<div class="tx-table-input-area">', '<div class="tx-field tx-col-field">@table.title.row<input type="text" value="1"><a class="tx-btn tx-btn-add" href="javascript:void 0;">@table.title.row+</a><a class="tx-btn tx-btn-sub" href="javascript:void 0;">@table.title.row-</a></div>', '<div class="tx-field tx-row-field">@table.title.col<input type="text" value="1"><a class="tx-btn tx-btn-add" href="javascript:void 0;">@table.title.col+</a><a class="tx-btn tx-btn-sub" href="javascript:void 0;">@table.title.col-</a></div>', "</div>"].join(""));
    g.Menu.Table = g.Class.create({
        ...
        generateTextSizer: function(w) {
            ...
            t.observe(v.collect(w, "div.tx-col-field a.tx-btn-add"), "click", function(A) {
                x.value = e.colSize = y.calculate(e.colSize, g.Menu.Table.MAX_COL, 1);
                t.stop(A);
                return c
            });
            t.observe(v.collect(w, "div.tx-col-field a.tx-btn-sub"), "click", function(A) {
                x.value = e.colSize = y.calculate(e.colSize, g.Menu.Table.MAX_COL, -1);
                t.stop(A);
                return c
            });
            ...
            t.observe(v.collect(w, "div.tx-row-field a.tx-btn-add"), "click", function(A) {
                z.value = e.rowSize = y.calculate(e.rowSize, g.Menu.Table.MAX_ROW, 1);
                t.stop(A);
                return c
            });
            t.observe(v.collect(w, "div.tx-row-field a.tx-btn-sub"), "click", function(A) {
                z.value = e.rowSize = y.calculate(e.rowSize, g.Menu.Table.MAX_ROW, -1);
                t.stop(A);
                return c
            })
    ...
    (function() {
        j.addMsg({
            "@emoticon.subtitle.person": "man",
            "@emoticon.subtitle.animal": "fauna and flora",
            ...
            var w = function(A) {
                ...
                if (x.isWYSIWYG()) {
                    x.execute(function(B) {
                        var C = B.pasteContent(z.html, u);
                        if (v.isTagName(C.parentNode, "p")) {
                            v.unwrap(C.parentNode)
                        }
                    })
                } else {
                    x.execute(function(B) {
    ...
    (function() {
        j.addMsg({
            "@specialchar.subtitle1": "General symbols",
            "@specialchar.subtitle2": "Mathematical signs, Currency Unit",
            "@specialchar.subtitle3": "Circle symbol, bracket",
            "@specialchar.subtitle4": "Japanese",
            "@specialchar.subtitle5": "Roman, Greece"
        });
    ...
    g.Tool.Advanced = g.Class.create({
        ...
        oninitialized: function(x) {
            ...
            w.observeJob(g.Ev.__CMD_ADVANCED_FOLD, function() {
                t.hide(z);
                t.removeClassName(A, "tx-toolbar-basic-open")
            });
            w.observeJob(g.Ev.__CMD_ADVANCED_SPREAD, function() {
                t.show(z);
                t.addClassName(A, "tx-toolbar-basic-open")
            });
            var y = function() {
                if (e.opened) {
                    w.fireJobs(g.Ev.__CMD_ADVANCED_FOLD)
                } else {
                    w.fireJobs(g.Ev.__CMD_ADVANCED_SPREAD)
                }
                e.opened = !e.opened
            };
        ...
        forceOpen: function() {
            this.button.pushedState();
            this.toolbar.fireJobs(g.Ev.__CMD_ADVANCED_SPREAD);
            this.opened = u
        }
    });
    ...
    p.addTool("codehighlight", {
        ...
        var w = p.getTool("codehighlight", e);
    ...
    g.Tool.Codehighlight = g.Class.create({
        $const: {
        ...
        oninitialized: function(w) {
            var e = this;
            this.highlight = w.highlight;
            this.canvas.observeElement({
                tag: "button",
                klass: "txc-code-wrap"
            }, function(x) {
                var y = v.first(x, "pre");
                e.isModify = true;
                e.target = y;
                e.toolbar.fireJobs(g.Ev.__TOOL_CLICK, e.identity, u)
            });
            this.toolbar.observeJob(g.Ev.__TOOL_CLICK, function(B, y) {
                if (B != "codehighlight") {
                    return
                }
                if (e.wysiwygonly && !e.canvas.isWYSIWYG()) {
                    alert(TXMSG("@codehighlight.insert.alert"));
                    return
                }
                if (!y) {
                ...
                if (e.clickHandler) {
                    ...
                    try {
                        var x = e.config.popPageUrl;
                        var z = (document.location.hostname != document.domain);
                        if (z) {
                            x = x + ((x.indexOf("?") > -1) ? "&" : "?") + "xssDomain=" + document.domain
                        }
                        x = (e.pvUrl ? e.pvUrl + ((e.pvUrl.indexOf("?") > -1) ? "&" : "?") + "u=" + escape(x) : x);
                        var A = h.open(x, "at" + e.name, e.config.features);
                        A.data = e.target ? (function() {
                            var C = [];
                            d.dom.getTextContent_(e.target, C, c);
                            return C.join("")
                        })() : "";
                        A.focus()
                    } catch (B) {}
        ...
        execAttach: function(w) {
            var x = Editor.getCanvas().getProcessor().doc;
            var e = x.createElement("button");
            e.className = "txc-code-wrap";
            e.innerHTML = '<pre class="txc-code"><code>' + this.highlight(w.code) + "</code></pre>";
            this.canvas.pasteNode(e, u)
        },
        execReattach: function(w) {
            var e = v.descendant(this.target, "code");
            e.innerHTML = this.highlight(w.code)
        },
        checkInsertable: function() {
            return !this.isModify
        }
    });
    g.register("add highlight css", function(x, y, z, w, e) {
        w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(C) {
            function B(D) {
                var E = C.createElement("link");
                E.setAttribute("rel", "stylesheet");
                E.setAttribute("type", "text/css");
                E.href = D;
                (C.head || C.getElementsByTagName("head")[0]).appendChild(E)
            }
            var A = e.toolbar.codehighlight.styleSheetUrl;
            if (!A) {
                return
            }
            if (t.isString(A)) {
    ...
    g.register("filter > codehighlight", function(C, D, w, y, z) {
        var A = z.toolbar.codehighlight.highlight;
        var x = C.getDocParser();

        function B(E) {
            E = E.replace(/(<pre[^>]*class=['"]?txc-code['"]?[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/ig, function(F, I, H, G) {
                return '<button class="txc-code-wrap">' + I + A(H) + G + "</button>"
            });
            return E
        }

        function e(E) {
            E = E.replace(/<button[^>]*>\s*(<pre[^>]*class=['"]?txc-code['"]?[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)\s*<\/button>/ig, function(F, I, H, G) {
                return I + H.stripTags() + G
            });
            return E
        }
        x.registerFilter("filter/codehighlight", {
            "text@load": function(E) {
                return E
            },
            "source@load": function(E) {
                return E
            },
            "html@load": function(E) {
                return B(E)
            },
            text4save: function(E) {
                return E
            },
            source4save: function(E) {
                return E
            },
            html4save: function(E) {
                return e(E)
            },
            text2source: function(E) {
                return E
    ...
    p.addTool("paste", {
        defaultMode: g.Paste.MODE_OFF,
        wysiwygonly: u,
        sync: c,
        status: u,
        options: [{
            label: "\ub044\uae30", //끄기
            title: "\ubd99\uc5ec\ub123\uae30\ub294 \ube0c\ub77c\uc6b0\uc800 \uae30\ubcf8 \uae30\ub2a5\uc744 \uc0ac\uc6a9\ud569\ub2c8\ub2e4",
            data: g.Paste.MODE_OFF,
            klass: "cell_ico clip_off"
        }, {
            label: "\ucf1c\uae30", //켜기
            title: "\ub0b4\uc6a9\uc744 \uc815\uc81c\ud574\uc11c HTML\ub85c \ubd99\uc5ec \ub123\uc2b5\ub2c8\ub2e4", //내용을 정제해서 HTML로 붙여 넣습니다
            data: g.Paste.MODE_HTML,
            klass: "cell_ico clip_on"
        }, {
            label: "\ubb38\uc790\ub9cc", //문자만
            title: "\ub0b4\uc6a9\uc744 Text\ub9cc \ubd99\uc5ec \ub123\uc2b5\ub2c8\ub2e4", //내용을 Text만 붙여 넣습니다
            data: g.Paste.MODE_TEXT,
            klass: "cell_ico clip_text"
        }]
    });
    g.Tool.Paste = g.Class.create({
        ...
        oninitialized: function(e) {
            ...
            var z = e.defaultMode;
            var w = function(D) {
                var B = this.button.elButton;
                var C = B.className.replace(/tx\-paste\-[a-z]+/gi, "");
                B.className = C + " tx-paste-" + D;
                var A = y.getPaster();
                A.switchMode(D)
            };
            this.weave.bind(this)(new g.Button.Select(p.merge(this.buttonCfg, {
    ...
    g.install("force init paste mode", function(y, z, A, x, w) {
        var e = y.getPaster();
        e.switchMode(w.toolbar.paste.defaultMode)
    });
    p.addTool("image", {
        disabledonmobile: u,
        wysiwygonly: u,
    ...
    g.module("Register an eventhandler in order to change align icons upon toolbar when user click a specific image or not.", function(y, A, B, x) {
        ...
        x.observeJob(g.Ev.__CANVAS_SELECT_ITEM, function() {
            var E;
            if (v.kindOf(x.getProcessor().getControlByAreaSelection(), "table")) {
                z("image")
            }
            if (v.kindOf(E = x.getProcessor().getControlByAreaSelection(), "img")) {
                var D = g.Util.getMatchedClassName(E, e);
                if (D || v.find(E, "button")) {
                    z("text")
                } else {
                    z("image")
                }
        ...
        x.observeJob(g.Ev.__CANVAS_UNSELECT_ITEM, function() {
            z("text")
        })
    });
    g.module("make padding area inside Canvas with editor width", function(A, K, M, y) {
        ...
        if (z) {
            ...
            y.observeJob(g.Ev.__CANVAS_NORMAL_SCREEN_CHANGE, C);
            y.observeJob(g.Ev.__CANVAS_FULL_SCREEN_CHANGE, C);
            if (!t.msie_nonstd) {
                if (t.gecko) {
                    t.setStyle(O, {
                        overflowX: "auto",
                    ...
                    if (t.chrome) {
                        t.setStyle(O.contentDocument.documentElement, {
                            overflowX: "auto",
                            overflowY: "auto"
                        })
                    } else {
    ...
    g.module("Add layer to display notice message on editor area before editing", function(x, y, z, w, e) {
        if (e.initializedMessage) {
            w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function() {
                var F = e.initializedId;
                var E = tx.div({
                    id: "tx-canvas-notice" + F,
                    className: "tx-canvas-notice"
                }, e.initializedMessage);
                var B = t("tx_loading" + F);
                var A = B.parentNode;
                A.insertBefore(E, B);
                var D = false;
                var C = function() {
                    if (!D && t("tx-canvas-notice" + F)) {
                        D = true;
                        A.removeChild(E);
                        w.focus()
                    }
    ...
    g.module("register drag and drop attacher on canvas", function(x, y, z, w, e) {
        if (!h.FileReader || !e.canvas.dropZone.use) {
            return
        }
        var A = new g.DropZone(x, z, w, e.canvas.dropZone);
        x.getDropZone = function() {
            return A
        }
    });
    g.register("filter > dropzone", function(z) {
        function C(D) {
            return D.replace(/([\\^$(){}[\]+*?.])/g, "\\$1")
        }

        function B(D) {
            return D.replace(y(), "").replace(w(), "")
        }

        function y() {
            return RegExp("<img[^>]*" + C(g.__WAITING_IMG_SRC) + "[^>]*id=['\"](.*)['\"][^>]*>", "g")
        }
        ...
        function A(D) {
            if (!z.hasOwnProperty("getDropZone")) {
                return D
            }
            var E = z.getDropZone();
            return D.replace(w(), function(H, J, I) {
                var G = E.getTempImageContents(J);
                if (G == i) {
                    return E.createIndicator(J)
                }
                var F = e.getEntries().find(function(K) {
                    return (K.data.dispElId == J)
                });
                F && F.setExistStage(true);
                return G
            })
        }
        var e = z.getAttachBox();
        var x = z.getDocParser();
        x.registerFilter("filter/dropzone", {
            "source@load": function(D) {
                return B(D)
            },
            "html@load": function(D) {
                return B(D)
            },
            source4save: function(D) {
                D = A(D);
                return B(D)
            },
            html4save: function(D) {
                return B(D)
            },
            text4save: function(D) {
                return D
            },
            html2text: function(D) {
                return B(D)
            },
            source2text: function(D) {
                return B(D)
            },
            source2html: function(D) {
                return A(D)
            },
            html2source: function(D) {
                if (!z.hasOwnProperty("getDropZone")) {
                    return D
                }
                return D.replace(y(), function(E, G, F) {
                    return "[Uploading:" + G + "]"
                })
            }
        })
    });
    g.MarkupTemplate.add("module.dropZone", '<div style="display: table; left:0px; top:0px; width:0px; height:0px; z-index:9999; border-spacing:6px; position:absolute;">        <div style="display:table-row">        <div style="background-color:white; border:4px dashed #cfcfcf; display:table-cell; opacity: .8; vertical-align:middle">        <div style="font-size: 40px; color:#cfcfcf; text-align:center;">\uc5ec\uae30\uc5d0 \ud30c\uc77c \ub193\uae30</div></div></div></div>');
    g.DropZone = g.Class.create({
        initialize: function(x, y, w, e) {
            this.editor = x;
            this.sidebar = y;
            this.canvas = w;
            this.config = e;
            this.useFileUpload = e.useFileUpload;
            this.useImageUpload = e.useImageUpload;
        ...
        _createCover: function() {
            var e = g.MarkupTemplate.get("module.dropZone").evaluateAsDom({});
            return e
        },
        _canvasObserveJobs: function() {
            var w = this;
            var x = t.debounce(function() {
                w.hideDragArea()
            }, 100);
            var e = function(y) {
                if (w._checkDragType(y) != -1) {
                    w.showDragArea();
                    x()
                }
            };
            this.canvas.observeJob(g.Ev.__CANVAS_PANEL_DRAGOVER, e);
            t.observe(h, "dragover", e);
            t.observe(h, "drop", function(y) {
                w._checkDragType(y)
            });
            t.observe(this.cover, "drop", function(y) {
                w._dropHandler(y)
            });
            this.canvas.observeJob(g.Ev.__CANVAS_MODE_CHANGE, function(z, y) {
                if (z == y) {
                    return
                }
                if (y == g.Canvas.__WYSIWYG_MODE) {
                    w.imgContents = {}
                }
            })
        },
        _checkDragType: function(y) {
            var e = this.dataType;
            var x = y.dataTransfer || i;
            var w = -1;
            if (this.canvas.isWYSIWYG() && x) {
                $A(x.types).each(function(A) {
                    var z = e.indexOf(A);
                    if (z < w || w == -1) {
                        t.stop(y);
                        w = z
        ...
        showDragArea: function() {
            ...
            var e = this.canvas.getPanel(g.Canvas.__WYSIWYG_MODE).el;
            var w = t.getOffset(e);
            v.applyStyles(this.cover, {
                left: w.left.toPx(),
                top: w.top.toPx(),
                width: (w.right - w.left).toPx(),
                height: (w.bottom - w.top).toPx()
            });
            v.insertNext(this.cover, b.body);
            this.coverShow = u
        },
        ...
        _dropHandler: function(z) {
            var e = this._checkDragType(z);
            if (e != -1) {
                var x = this.canvas.getProcessor();
                if (x.savedRange) {
                    x.savedRange.select()
                ...
                var w = this.dataType[e];
                var y = z.dataTransfer;
                if (w == "Files") {
                    this.attachFiles($A(y.files))
                } else {
                    this.attachHtml(y.getData(w))
                }
                t.stop(z)
            }
        },
        attachFiles: function(y) {
            if (!y || !y.length) {
                return
            }
            var w = this;
            ...
            var e;
            y.each(function(z) {
                if (w.useImageUpload && z.type && z.type.split("/")[0].toUpperCase() == "IMAGE") {
                    e = w.attachImage(z)
                } else {
                    if (w.useFileUpload) {
                        e = w.attachFile(z)
        ...
        attachImage: function(y) {
            var x = this;
            var w = this.insertIndicator();
            var e = new FileReader();
            t.observe(e, "loadend", function(A) {
                var z = {};
                z.imageurl = this.result;
                x._execAttach(z, w)
            });
            e.readAsDataURL(y)
        },
        attachHtml: function(w) {
            var e = this.editor.getPaster();
            e.pasteHTML(w)
        },
        insertIndicator: function() {
            var e = g.Util.getDispElId();
            this.canvas.getProcessor().pasteContent(this.createIndicator(e), u);
            return e
        },
        createIndicator: function(e) {
            return "<img src=" + g.__WAITING_IMG_SRC + " width=16 height=16 id=" + e + ">"
        },
        _getIndicator: function(x) {
            if (this.canvas.isWYSIWYG()) {
                var e = this.canvas.getCurrentPanel().getDocument();
                var w = v.collect(e, "#" + x);
                return w
            }
            return i
        },
        _removeIndicator: function(w) {
            if (!w || w == "") {
                return
            }
            if (this.canvas.isWYSIWYG()) {
                var e = this._getIndicator(w);
                if (e) {
                    d.dom.removeNode(e)
                }
            } else {
        ...
        _execAttach: function(x, w) {
            var e = this;
            if (x.hasOwnProperty("imageurl")) {
                this.canvas.execute(function(z) {
                    var y = b.createElement("img");
                    y.src = x.imageurl;
                    v.addStyles(y, {
                        clear: "none",
                        "float": "none"
                    });
                    if (e.canvas.isWYSIWYG()) {
                        var A = e._getIndicator(w);
                        if (A) {
                            d.dom.replaceNode(y, A)
                        }
                    } else {
                        e.imgContents[w] = d.dom.getOuterHtml(y)
                    }
                })
            }
        },
        getTempImageContents: function(e) {
            return this.imgContents[e] || i
        },
        alertMessage: function(x) {
            if (!x || x.length == 0) {
                return
            }
            var y = [];
            y.push("check your files\n");
            var e;
            for (var w = 0; w < x.length; w++) {
                e = x[w];
                y.push("\n" + e.name);
                if (e.size) {
                    y.push(" (" + e.size.toByteUnit() + ")")
                }
            }
            this.alertTimeout(y.join(""))
        },
        alertTimeout: function(e) {
            setTimeout(function() {
                alert(e)
            }, 1)
        }
    ...
    j.addMsg({
        "@table.noselect.alert": "After you select a table available."
    });
    g.Table = {};
    g.module("table selector", function(y, z, A, x, w) {
        ...
        x.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function() {
            ...
            F = new g.Table.Insert(y, w);
            G = new g.Table.Delete(y, w);
            J = new g.Table.Border(y, w);
            L = new g.Table.Resize(y, w);
            D = new g.Table.TemplateLoader();
            e(x);
            var N = x.getPanel(g.Canvas.__WYSIWYG_MODE);
            var E = N.getProcessor();
            var I = function() {
                var O, P;
                if (H.getSelected().isValid() === c) {
                    O = E.getNode();
                    P = g.TableUtil.getClosestByTagNames(["td", "th"], O);
                    if (P) {
                        H.selectByTd(P, P)
                    }
                }
            ...
            var M = function() {
                var O = z.tools.cellslinecolor;
                if (O) {
                    B.color = O.config.defaultcolor
                }
            };
            M();
            var K = function() {
            ...
            E.table = {
                ...
                setNoBorder: function() {
                    ...
                    this.execute(function() {
                        ...
                        J.changeBorderColor(O.getTdArr(), "");
                        J.changeBorderHeight(O.getTdArr(), "0");
                        J.changeBorderType(O.getTdArr(), "none")
                    })
                },
                setBorderButtons: function(P, O, R) {
                    var Q;
                    Q = z.tools.cellslinecolor;
                    if (Q) {
                        Q.execute(P)
                    }
                    Q = z.tools.cellslineheight;
                    if (Q) {
                        Q.execute(O)
                    }
                    Q = z.tools.cellslinestyle;
                    if (Q) {
                        Q.execute(R)
                    }
                },
                ...
                applyBorder: function() {
                    ...
                    this.execute(function() {
                        ...
                        J.changeBorderColor(O.getTdArr(), B.color);
                        J.changeBorderHeight(O.getTdArr(), B.height);
                        J.changeBorderType(O.getTdArr(), B.type);
                        O.addBorderHistory()
                    })
                },
                addBorderHistory: function() {
                    var O;
                    O = z.tools.cellslinepreview;
                    if (O) {
                        O.addBorderHistory(B)
                    }
                },
                ...
                setTemplateStyle: function(Q, P) {
                    if (Q) {
                        var O = this;
                        D.getTemplate(P, function(R) {
                            R.apply(Q);
                            O._applyTemplateOutline(Q, R.templateData);
                            H.reset()
                        })
                    } else {
                        K()
                ...
                _applyTemplateOutline: function(V, O) {
                    var W = O;
                    var X = this;
                    var Q = {
                        top: this._parseBorderStyle(W.firstRow.borderTop),
                        right: this._parseBorderStyle(W.lastCol.borderRight || W.common.borderRight),
                        bottom: this._parseBorderStyle(W.lastRow.borderBottom || W.common.borderBottom),
                        left: this._parseBorderStyle(W.firstCol.borderLeft)
                    };
                    var T = new g.Tool.Table.TableCellMatrixer(V);
                    var P = T.getTdMatrix();
                    var U = T.getRowSize();
                    var R = T.getColSize();
                    if (P && P.length) {
                        H.selectByTd(P[0][0], P[U - 1][R - 1]);
                        J.setTableSelect(H);
                        var S = ["top", "right", "bottom", "left"];
                        S.each(function(Y) {
                            J.setBorderRange(Y);
                            J.changeBorderColor(X.getTdArr(), Q[Y]["color"]);
                            J.changeBorderHeight(X.getTdArr(), Q[Y]["height"]);
                            J.changeBorderType(X.getTdArr(), Q[Y]["type"])
                        })
                    }
                },
                _parseBorderStyle: function(O) {
                ...
                resize: function(P, O) {
                    this.execute(function() {
                        if (P.width != null) {
                            L.resize(H, "WIDTH", P.width, O)
                        }
                        if (P.height != null) {
                            L.resize(H, "HEIGHT", P.height, O)
                        }
                    })
                }
            };
            ...
            z.observeJob(g.Ev.__TOOL_CLICK, function(O) {
                if (["fontfamily", "fontsize", "bold", "underline", "italic", "strike", "forecolor", "backcolor", "indent", "outdent", "alignleft", "aligncenter", "alignright", "alignfull", "mergecells", "splitcells", "insertcells", "deletecells", "cellsoutline", "cellslinecolor", "cellslineheight", "cellslinestyle", "cellslinepreview", "tablebackcolor", "tabletemplate", "tableresize", "tablevalign"].contains(O) === c) {
                    H.reset()
                }
                if (O === "tablebackcolor") {
                    I()
    ...
    g.Table.Selector = g.Class.create({
        ...
        initialize: function(w, e) {
            ...
            this.tableIndexer = i;
            this.selectModeKeyObserver = new(g.Class.create({
                $mixins: [g.I.KeyObservable],
                initialize: function() {}
            }));
            this.normalModeKeyObserver = new(g.Class.create({
                $mixins: [g.I.KeyObservable],
                initialize: function() {}
            }));
            this.applyCss();
        ...
        observeEvent: function() {
            var C;
            C = this;
            this.canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEDOWN, function(G) {
                var F;
                F = t.element(G);
                C.onmousedown(F)
            });
            t.observe(this.htmlBody, "mousemove", function(G) {
                var F;
                F = t.element(G);
                C.onmousemove(F)
            });
            this.canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, function(F) {
                C.onmouseup()
            });
            var w;
            try {
            ...
            t.observe(w, "mouseup", function(F) {
                C.onmouseup()
            });
            this.canvas.observeJob(g.Ev.__CANVAS_PANEL_KEYDOWN, function(F) {
                if (C.isDragging) {
                    t.stop(F);
                    C.reset()
                } else {
            ...
            this.canvas.observeJob(g.Ev.__CANVAS_DATA_INITIALIZE, function(e) {
                if (e === g.Canvas.__WYSIWYG_MODE) {
                    C.clearSelected()
                }
            });
            ...
            function y(F) {
                var G, e;
                if (C.canvas.config.readonly === c) {
                    G = g.TableUtil.getClosestByTagNames(["td", "th"], F);
                    e = v.find(G, ".txc-info");
                    if (G && !e) {
                        return G
                    }
            ...
            this.config.cellSelect && this.config.cellSelect.hotKeyUse && this.canvas.observeKey(this.config.cellSelect.hotKey, function(G) {
                var F, H;
                F = C.canvas.getProcessor().getNode();
                H = y(F);
                if (!H) {
                    return
                }
                ...
                C.selectStart(H);
                C.applySelected();
                g.TableUtil.collapseCaret(C.wysiwygPanel, F)
            }, u);

            function z(G) {
                var e = C.tableIndexer.getBoundary(C.currentTd);
                var H = G(e);
                var F = C.tableIndexer.getTd(H.top, H.left);
                if (!F) {
                    return
                }
                C.selectEnd(F);
            ...
            this.selectModeKeyObserver.observeKey({
                ...
                C.selectRow(C.currentTd, "RIGHT");
                C.applySelected();
                g.TableUtil.collapseCaret(C.wysiwygPanel, C.currentTd)
            });
            this.selectModeKeyObserver.observeKey({
                shiftKey: u,
                keyCode: 37
            }, function(F) {
                C.selectRow(C.currentTd, "LEFT");
                C.applySelected();
                g.TableUtil.collapseCaret(C.wysiwygPanel, C.currentTd)
            });
            this.selectModeKeyObserver.observeKey({
            ...
            this.selectModeKeyObserver.observeKey({
                ...
                C.selectCol(C.currentTd, "BOTTOM");
                C.applySelected();
                g.TableUtil.collapseCaret(C.wysiwygPanel, C.currentTd)
            });
            this.selectModeKeyObserver.observeKey({
                ...
                C.canvas.getProcessor().table.resize({
                    width: 5
                }, u)
            });
            this.selectModeKeyObserver.observeKey({
            ...
            function B(F) {
                var e = C.canvas.getProcessor().getRange();
                e[(F ? "setEndBefore" : "setEndAfter")](C.currentTable);
                e.collapse(c);
                d.dom.Range.createFromBrowserRange(e).select()
            }
            ...
            function D(F, e) {
                return v.ancestor(F, "table") === v.ancestor(e, "table")
            }
            t.webkit && this.normalModeKeyObserver.observeKey({
                keyCode: 38
            }, function(G) {
                var F, H;
                F = C.canvas.getProcessor().getNode();
                ...
                setTimeout(function() {
                    if (E(F)) {
                        ...
                        var e = C.tableIndexer.getBoundary(H);
                        H = C.tableIndexer.getTd(e.top - 1, e.left);
                        if (!H) {
                            B(u)
                        } else {
                            g.TableUtil.collapseLastCaret(C.wysiwygPanel, H)
                        }
                    }
                }, 0)
            });
            t.webkit && this.normalModeKeyObserver.observeKey({
                ...
                setTimeout(function() {
                    if (E(F)) {
                        ...
                        var e = C.tableIndexer.getBoundary(H);
                        H = C.tableIndexer.getTd(e.bottom + 1, e.left);
                        if (!H) {
                            B(c)
                        } else {
                            g.TableUtil.collapseCaret(C.wysiwygPanel, H)
                        }
                    }
                }, 0)
            })
        ...
        onmousemove: function(y) {
            var A, x, z, w;
            var e = this.canvas.getProcessor();
            if (e.getAreaSelection().isResizing || (t.msie && t.msie_ver >= 11 && (w = e.getControl()) && v.kindOf(w, "img,table"))) {
                this.turnOffDragging();
                return
            }
            if (this.isDragging) {
                A = g.TableUtil.getClosestByTagNames(["td", "th"], y);
                if (A) {
                    x = g.TableUtil.getClosestByTagNames(["table"], A);
                    if (x === this.currentTable && A !== this.currentTd) {
                        this.isSelectMode = u;
                        this.selectEnd(A);
                        this.applySelected();
                    ...
                    z = (this.endCellBoundary === this.startCellBoundary);
                    if (this.currentTd && z) {
        ...
        onkeydown: function(y) {
            ...
            if (this.isSelectMode) {
                t.stop(y);
                this.selectModeKeyObserver.fireKeys(y)
            } else {
                if (z === c) {
                    this.normalModeKeyObserver.fireKeys(y, u);
                    this.reset()
                }
            }
        },
        ...
        selectRow: function(z, x) {
            this.currentTd = z;
            var e = this.tableIndexer.getBoundary(z);
            var y = i,
                w = i;
            if (x == "RIGHT") {
                w = this.tableIndexer.getTd(e.top, this.tableIndexer.getColSize() - 1)
            } else {
                if (x == "LEFT") {
                    w = this.tableIndexer.getTd(e.top, 0)
                } else {
                    y = this.tableIndexer.getTd(e.top, 0);
                    w = this.tableIndexer.getTd(e.top, this.tableIndexer.getColSize() - 1);
                    this.startCellBoundary = this.tableIndexer.getBoundary(y)
                }
            }
            this.endCellBoundary = this.tableIndexer.getBoundary(w);
            this.currentTd = w
        },
        selectCol: function(z, x) {
            this.currentTd = z;
            var e = this.tableIndexer.getBoundary(z);
            var y = i,
                w = i;
            if (x == "BOTTOM") {
                w = this.tableIndexer.getTd(this.tableIndexer.getRowSize() - 1, e.left)
            } else {
                if (x == "TOP") {
                    w = this.tableIndexer.getTd(0, e.left)
                } else {
                    y = this.tableIndexer.getTd(0, e.left);
                    w = this.tableIndexer.getTd(this.tableIndexer.getRowSize() - 1, e.left);
                    this.startCellBoundary = this.tableIndexer.getBoundary(y)
                }
            }
        ...
        selectTable: function() {
            var w = this.tableIndexer.getTd(0, 0);
            var e = this.tableIndexer.getTd(this.tableIndexer.getRowSize() - 1, this.tableIndexer.getColSize() - 1);
            this.startCellBoundary = this.tableIndexer.getBoundary(w);
            this.endCellBoundary = this.tableIndexer.getBoundary(e);
            this.currentTd = e
        },
    ...
    g.Table.Resize = g.Class.create({
        ...
        resize: function(e, x, z, y) {
            var w = i;
            if (x == this.TYPE.WIDTH) {
                w = this._makeTDArrWidth(e)
            } else {
                w = this._makeTDArrHeight(e)
            }
            if (w.expandElement == 0) {
                return
            }
            if (x == this.TYPE.WIDTH) {
                this._resizeWidth(w.expandElement, z, y);
                this._resizeTableWidth(e.currentTable)
            } else {
                this._resizeHeight(w.expandElement, z, y);
                this._deleteTableHeight(e.currentTable)
            }
        },
        _range: function(z, e, x) {
            var w = [];
            var y = z;
            while (z <= y && y <= e) {
                w.push(y);
        ...
        _makeTDArrWidth: function(w) {
            var e = w.getSelected();
            var y = w.getIndexer();
            var z = y.getTdArrCol.apply(y, this._range(e.left, e.right, 1));
            var x = [];
            return {
                expandElement: z,
                contractElement: x
        ...
        _makeTDArrHeight: function(w) {
            var e = w.getSelected();
            var y = w.getIndexer();
            var z = y.getTdArrRow.apply(y, this._range(e.top, e.bottom, 1));
            var x = [];
            return {
                expandElement: z,
                contractElement: x
        ...
        _resizeWidth: function(w, z, y) {
            var x = 10;
            if (w) {
                for (var e = 0; e < w.length; e++) {
                    w[e].style.width = Math.max((y ? this._getTdWidth(w[e]) : 0) + (z * w[e].colSpan || 1), x).toPx()
                }
            }
        },
        _resizeTableWidth: function(w) {
            if (!w || !w.rows) {
                return
            }
            var e = Math.min(this._getTableWidth(w), this.canvas.getSizeConfig().contentWidth);
            w.width = e.toPx();
            w.style.width = e.toPx()
        },
        _getTableWidth: function(x) {
            if (!x || !x.rows) {
                return 0
            }
            var w = 0;
            var e = this;
            Array.prototype.each.call(x.rows[0].children, function(y) {
                w += e._getTdWidth(y)
            });
            return w
        },
        _getTdWidth: function(w) {
            var e = w.width || w.style.width;
            if (e.indexOf("%") != -1) {
                return w.offsetWidth
            } else {
        ...
        _resizeHeight: function(w, z, x) {
            var y = 20;
            if (w) {
                for (var e = 0; e < w.length; e++) {
                    w[e].style.height = (Math.max(parseInt((x ? w[e].style.height : 0), 10) + (z * w[e].rowSpan || 1), y)).toPx()
                }
            }
        },
        _deleteTableHeight: function(e) {
            e.height = "";
            e.style.height = ""
        }
    });
    ...
    g.MarkupTemplate.add("module.areaselect", '<div class="tx-area-selection" contenteditable="false" style="visibility:hidden;position:absolute;z-index:999;display: block; left: 0px;line-height:1; top: 0px; width: 0px; height: 0px;"><div class="tx-area-move-holder" style="display:none;visibility:visible;position: absolute; z-index: 1000; line-height: 1; cursor:move; top: -4px; left: -5px; border:1px solid #FFFFFF;width:8px;height:8px;background-color: #000000;"></div><div class="tx-area-holder-sw" style="visibility:visible;position: absolute; z-index: 1000; line-height: 1; bottom: -4px; left: -5px; border:1px solid #000000;width:5px;height:5px;border-right:0;border-top:0;"></div><div class="tx-area-holder-sw" style="visibility:visible;position: absolute; z-index: 1000; line-height: 1; top: -4px; right: -3px; border:1px solid #000000;width:5px;height:5px;border-left:0;border-bottom:0;"></div><div class="tx-area-holder" style="visibility:visible;position: absolute; z-index: 1000; line-height: 1; cursor:nw-resize; bottom: -4px; right: -5px; border:1px solid #000000;width:8px;height:8px;background-color: #FFFFFF;"></div><div class="tx-area-selection-info" style="visibility:visible;display:none;position: absolute; z-index:1002; line-height: 1;bottom: 10px; right: 5px; background-color:#000000;font-size:12px;color:#FFFFFF;padding: 3px">0x0</div></div>');
    g.Area = {};
    g.Area.BrowserSelect = g.Class.create({
        initialize: function(e) {
            this._canvas = e.getCanvas();
            this._panel = this._canvas.getPanel(g.Canvas.__WYSIWYG_MODE);
        ...
        select: function(w) {
            ...
            var e;
            if ((e = this._canvas.getProcessor()).getControl() !== w) {
                e.selectControl(w)
            }
            this._isSelect = u;
            this._canvas.fireJobs(g.Ev.__CANVAS_SELECT_ITEM)
        },
        update: function(e) {},
        reset: function() {
            if (this.isSelect()) {
                this._canvas.fireJobs(g.Ev.__CANVAS_UNSELECT_ITEM)
            }
            this._isSelect = c
        },
        isSelect: function() {
    ...
    g.Area.Select = g.Class.create({
        ...
        _getPosition: function(w) {
            var y = t.getOffset(w);
            var x = y.right - y.left;
            var e = y.bottom - y.top;
            y.width = x;
            y.height = e;
            return y
        },
        _setSelectStyle: function(e) {
            t.setStyle(this._selectElement, e)
        },
        _setSelectInfo: function(x, e) {
            var w = 100;
            var y = 50;
            var z = v.collect(this._selectElement, ".tx-area-selection-info");
            z.innerHTML = (x | 0) + "x" + (e | 0);
            if (x < w || e < y) {
                t.setStyle(z, {
                    right: "",
                    left: (x + 10).toPx()
        ...
        _makeSelect: function(w) {
            if (!w) {
                this.reset()
            } else {
                var e = this._getPosition(w);
                t.show(this._selectElement);
                this._setSelectStyle({
                    top: e.top.toPx(),
                    left: e.left.toPx(),
                    width: e.width.toPx(),
                    height: e.height.toPx()
                });
                this._setSelectInfo(e.width, e.height)
            }
        },
        _makeElement: function() {
            var e = g.MarkupTemplate.get("module.areaselect").evaluateAsDom({});
            t.setOpacity(v.collect(e, ".tx-area-selection-info"), 0.7);
            return e
        },
        isSelect: function() {
            return this._isSelect
        ...
        select: function(w) {
            ...
            var e = this;
            if (v.kindOf(w, "img")) {
                e._canvas.getProcessor().createGoogFromNodeContents(w).select()
            }
            this._target = w;
            v.insertNext(this._selectElement, this._doc.body);
            this._isSelect = u;
            this._makeSelect(w);
            this._canvas.fireJobs(g.Ev.__CANVAS_SELECT_ITEM)
        },
        update: function(e) {
            this._makeSelect(e || this._target)
        },
        reset: function() {
            if (this.isSelect()) {
                this._canvas.fireJobs(g.Ev.__CANVAS_UNSELECT_ITEM)
    ...
    g.Area.Resize = g.Class.create({
        ...
        initialize: function(e) {
            this._select = e;
            this._holer = v.collect(this.getOrigin()._selectElement, ".tx-area-holder");
            this._info = v.collect(this.getOrigin()._selectElement, ".tx-area-selection-info");
            this._state = "NONE";
        ...
        _observeEvent: function() {
            var e = this;
            t.observe(this._holer, "mousedown", function(w) {
                e._mousedown(w)
            }, false);
            t.observe(this._holer, "mouseup", function(w) {
                e._mouseup(w)
            }, false);
            t.observe(this._holer, "mousemove", function(w) {
                e._mousemove(w)
            }, false);
            t.observe(b.body, "mouseup", function(w) {
                e._mouseup(w)
            }, false);
            t.observe(b.body, "mousemove", function(w) {
                e._mousemove(w)
            }, false);
            this._canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEMOVE, function(w) {
                e._mousemove(w)
            });
            this._canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, function(w) {
                e._mouseup(w)
            })
        },
        _mousedown: function(x) {
            if (this._state === "NONE") {
                ...
                this._mouseData.downPoint = this._getPointByEvent(x);
                var y = t.getOffset(this._select.getTarget());
                this._mouseData.targetOffset = y;
                var w = this._select.getTarget().cloneNode(u);
                t.setStyle(w, {
                    position: "absolute",
                    top: y.top.toPx(),
                    left: y.left.toPx(),
                ...
                t.setOpacity(w, 0.3);
                v.insertNext(w, this._doc.body);
                this._mouseData.moveTarget = w;
                t.stop(x)
            }
        },
        _mouseup: function(x) {
            if (this._state === "DRAG") {
                ...
                v.remove(this._mouseData.moveTarget);
                this._resize(this._select.getTarget(), w ? this._ratio(this._mouseData.targetOffset, this._getPointByEvent(x)) : this._getPointByEvent(x));
                this._mouseData.moveTarget = i;
                t.hide(this._info);
                this.update();
                t.stop(x);
        ...
        _mousemove: function(x) {
            if (this._state === "DRAG") {
                ...
                this._resize(this._mouseData.moveTarget, w ? this._ratio(this._mouseData.targetOffset, this._getPointByEvent(x)) : this._getPointByEvent(x));
                this.update(this._mouseData.moveTarget);
                t.stop(x)
            }
        },
        _ratio: function(z, e) {
            var y = this._subtractPoint(e, this._mouseData.downPoint);
            var w = (z.right - z.left) / (z.bottom - z.top);
            var x = c;
            if (y[0] < 1 / w * y[1]) {
                x = u
            }
            return this._addPoint(this._mouseData.downPoint, [x ? y[0] : w * y[1], x ? 1 / w * y[0] : y[1]])
        },
        _resize: function(w, e) {
            if (!w) {
                return
            }
            var x = this._subtractPoint(e, this._mouseData.downPoint);
            this._setWidth(w, x[0]);
            this._setHeight(w, x[1])
        },
        _setWidth: function(x, y) {
            var e = this._mouseData.targetOffset.right - this._mouseData.targetOffset.left;
            var w = (Math.min(Math.max(e + y, 10), this._canvas.getSizeConfig().contentWidth)).toPx();
            x.width = w;
            x.style.width = w
        },
        _setHeight: function(x, y) {
            var w = this._mouseData.targetOffset.bottom - this._mouseData.targetOffset.top;
            var e = (Math.max(w + y, 10)).toPx();
            x.height = e;
            x.style.height = e
        },
        _changeState: function(e) {
            if (!["NONE", "READY", "DRAG"].contains(e)) {
                return
            }
            this._state = e
        },
        ...
        select: function(e) {
            this._select.select(e);
            t.show(this._holer)
        },
        update: function(e) {
            this._select.update(e)
        },
        reset: function() {
            this._select.reset();
            t.hide(this._info);
    ...
    g.Area.Move = g.Class.create({
        ...
        initialize: function(e) {
            this._select = e;
            this._holer = v.collect(this.getOrigin()._selectElement, ".tx-area-move-holder");
            this._state = "NONE";
            this._canvas = this.getOrigin()._getCanvas();
            this._panel = this.getOrigin()._getPanel();
            this._doc = this.getOrigin()._getDocument();
        ...
        _mouseup: function(y) {
            if (this._state === "DRAG") {
                ...
                v.remove(this._mouseData.moveTarget);
                if (!x) {
                    this._move(this._select.getTarget(), this._getPointByEvent(y));
                    setTimeout(this.select.bind(this, this._select.getTarget()), 35)
                } else {
                    var w = this._select.getTarget().cloneNode(true);
                    this._move(w, this._getPointByEvent(y));
                    setTimeout(this.select.bind(this, w), 35)
                }
                this._mouseData.moveTarget = i;
                t.stop(y);
                this._canvas.history.saveHistory()
        ...
        _mousemove: function(w) {
            if (this._state === "DRAG") {
                this._moving(this._mouseData.moveTarget, this._getPointByEvent(w));
                this.update(this._mouseData.moveTarget);
                t.stop(w)
            }
        },
        _moving: function(w, e) {
            t.setStyle(w, {
                position: "absolute",
                left: (e[0] + 10).toPx(),
                top: (e[1] + 10).toPx()
            });
            var x = this._canvas.getProcessor();
            this._canvas.focus();
            x.moveSelection(e[0], e[1])
        },
        _move: function(y, w) {
            var A = this._canvas.getProcessor();
            this._canvas.focus();
            try {
                var x = A.getNode();
                if (!v.findAncestor(x, function(e) {
    ...
    g.Area.Control = g.Class.create({
        $mixins: [g.I.KeyObservable],
        initialize: function(e) {
            this._select = e;
            this._canvas = e._canvas;
            this._observeEvent()
        },
        _observeEvent: function() {
            var e = this;
            ...
            this._canvas.observeJob(g.Ev.__CANVAS_PANEL_KEYDOWN, function(w) {
                if (/^(16|17|18|46|8)$/.test(w.keyCode)) {
                    e.fireKeys(w, u)
                } else {
                    e.reset()
                }
    ...
    g.module("area select", function(x, y, z, w, e) {
        w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(F) {
            var C = w.getProcessor(g.Canvas.__WYSIWYG_MODE);
            var E;
            if (t.msie) {
                E = new g.Area.BrowserSelect(x)
            } else {
                E = new g.Area.Control(new g.Area.Resize(new g.Area.Select(x)));
                if (b.caretPositionFromPoint || b.caretRangeFromPoint) {
                    E = new g.Area.Move(E)
                }
            }
            C.getAreaSelection = function() {
                return E
            };
            var I = g.__EXCLUDE_IMG;
            var H = i,
                D, B;
            if (t.msie) {
                E.isResizing = false;
                ...
                t.observe(F.body, "resizestart", G);
                t.observe(F.body, "resizeend", A);
                B = function B(K) {
                    var J = t.element(K);
                    H = J;
                    if (v.kindOf(J, "table") && J !== E.getTarget()) {
                        t.stop(K)
                    } else {
                        E.reset()
                    }
                ...
                D = function D(K) {
                    var J = t.element(K);
                    if (J != H || !v.kindOf(J, "img")) {
                        E.reset();
                        H = i;
                        return
                    }
                    if (v.kindOf(J, "img,table") && !g.Util.getMatchedClassName(J, I)) {
                        E.select(J)
                    }
                }
            } else {
                ...
                D = function D(K) {
                    var J = t.element(K);
                    if (J != H || (!v.kindOf(J, "img") && !C.isCollapsed())) {
                        E.reset();
                        H = i;
                        return
                    }
                    if (v.kindOf(J, "img,table") && !g.Util.getMatchedClassName(J, I) && !v.find(J, "button")) {
                        E.select(J)
                    }
                }
            }
            w.observeJob(g.Ev.__CANVAS_PANEL_MOUSEDOWN, B);
            w.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, D);
            w.observeJob(g.Ev.__CANVAS_SELECT_ITEM, function() {
                var J = w.getProcessor().createGoogFromNodeContents(E.getTarget());
                if (J) {
                    w.fireJobs(g.Ev.__CANVAS_PANEL_QUERY_STATUS, J)
                }
            });
            w.observeJob(g.Ev.__CANVAS_PANEL_SCROLLING, function(J) {
                E.update()
            });
            t.observe(b.body, "mousedown", function(J) {
                E.reset()
            });
            y.observeJob(g.Ev.__TOOL_CLICK, function(J) {
                if (/align(center|full|left|right)/.test(J) && v.kindOf(E.getTarget(), "table,img")) {} else {
                    E.reset()
                }
            })
        })
    });
    g.module("page up & down", function(x, y, z, w, e) {
        w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function(C) {
            function B() {
                A()
            }
            ...
            function A() {
                var E = (h.pageYOffset || b.documentElement.scrollTop) - (b.documentElement.clientTop || 0);
                var D = (h.pageXOffset || b.documentElement.scrollLeft) - (b.documentElement.clientLeft || 0);

                function F(G) {
                    window.scrollTo(D, E)
                }
                t.observe(h, "scroll", F);
                setTimeout(function() {
                    t.stopObserving(h, "scroll", F)
                }, 30)
            }
            t.observe(C, "keydown", function(D) {
                if (/^(33|34)$/.test(D.keyCode)) {
                    B()
                }
            })
        })
    });
    g.Table.Dragger = g.Class.create({
        EDGE_TYPE: {
            TOP: "EDGE_TOP",
            BOTTOM: "EDGE_BOTTOM",
            LEFT: "EDGE_LEFT",
        ...
        $mixins: [g.I.point],
        initialize: function(w, e) {
            this._canvas = w.canvas;
            this._panel = this._canvas.getPanel(g.Canvas.__WYSIWYG_MODE);
            this._doc = this._panel.getDocument();
            this._win = this._panel.getWindow();
            this._config = e;
            this._colGuide = v.collect(this._canvas.wysiwygEl, ".tx-table-col-resize-dragger");
            this._rowGuide = v.collect(this._canvas.wysiwygEl, ".tx-table-row-resize-dragger");
            this._mouseData = {
                downPoint: [0, 0],
                moveTd: i,
        ...
        mousedown: function(x) {
            if (this._state == "NONE") {
                var y = this._mouseData.moveTd;
                if (!y || !y.parentNode) {
                    return
                }
                var w = this._getPointByEvent(x);
                if (this._getType(y, w) == "NONE") {
                    return
                }
                t.stop(x);
                this._setMouseDownData(y, w);
                this._changeState("READY")
            }
        },
        mousemove: function(A) {
            var w = this._getPointByEvent(A);
            if (this._state == "NONE") {
                if (this._canvas.getProcessor().table.isDuringSelection()) {
                    return
                }
                var B = this._getTdByEvent(A);
                this._mouseData.moveTd = B;
                var x = this._getType(B, w);
                this._makeGuide(x, this._state, w)
            }
            if (this._state == "READY") {
                if (this._distancePoint(this._mouseData.downPoint, w) > 6) {
                    this._changeState("DRAG")
                }
                this._makeGuide(this._mouseData.downType, this._state, w)
            }
            if (this._state == "DRAG") {
                var y = this._makeTDArr(this._mouseData.downTd, this._mouseData.downType, v.find(this._mouseData.downTd, "table"));
                var z = this._calMinMaxPoint(y, w, this._mouseData.downType);
                this._makeGuide(this._mouseData.downType, this._state, z)
            }
        },
        mouseup: function(x) {
            var z = this._canvas.getProcessor().getAreaSelection();
            if (this._state == "DRAG") {
                z.reset();
                var y = this._makeTDArr(this._mouseData.downTd, this._mouseData.downType, v.find(this._mouseData.downTd, "table"));
                var e = this._getPointByEvent(x);
                this._resize(y, e, this._mouseData.downType)
            }
            if (this._state == "READY") {
                var w;
                w = v.find(this._mouseData.downTd, "table");
                if (!w) {
                    z.reset();
                    return
                }
            ...
            if (this._state != "NONE") {
                this._changeState("NONE");
                this._makeGuide(this.EDGE_TYPE.NONE, "NONE", this._getPointByEvent(x));
                this._setMouseDownData(i, [0, 0])
            }
        },
        _observeEvent: function() {
            var e = this;
            t.observe(b.body, "mouseup", function(w) {
                if (!e._canvas.isWYSIWYG()) {
                    return
                }
                e.mouseup(w)
            });
            ...
            this._canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEDOWN, function(w) {
                e.mousedown(w)
            });
            t.observe(this._rowGuide, "mousedown", function(w) {
                e.mousedown(w);
                if (e._state != "DRAG") {
                    if (e._mouseData.moveTd) {
                        g.TableUtil.collapseCaret(e._panel, e._mouseData.moveTd)
                    }
                }
            });
            t.observe(this._colGuide, "mousedown", function(w) {
                e.mousedown(w);
                if (e._state != "DRAG") {
                    if (e._mouseData.moveTd) {
                        g.TableUtil.collapseCaret(e._panel, e._mouseData.moveTd)
            ...
            t.observe(this._rowGuide, "mouseup", function(w) {
                e.mouseup(w)
            });
            t.observe(this._colGuide, "mouseup", function(w) {
                e.mouseup(w)
            })
        },
        _changeState: function(e) {
        ...
        _makeTDArr: function(C, z, A) {
            var y = new g.TableUtil.Indexer(A);
            var e = y.getBoundary(C);
            var w = [],
                B = [];
            var x = {
                EDGE_TOP: function() {
                    w = y.getTdArrHasBottom(e.top - 1)
                },
                EDGE_BOTTOM: function() {
                    w = y.getTdArrHasTop(e.bottom)
                },
                EDGE_LEFT: function() {
                    if (e.left > 0) {
                        w = y.getTdArrHasRight(e.left - 1);
                        B = y.getTdArrHasLeft(e.left)
                    }
                },
                EDGE_RIGHT: function() {
                    w = y.getTdArrHasRight(e.right);
                    if (e.right < y.getColSize() - 1) {
                        B = y.getTdArrHasLeft(e.right + 1)
                    }
                }
            };
            x[z]();
        ...
        _setGuideStyle: function(e, w) {
            t.setStyle(e, w)
        },
        _makeGuide: function(y, A, e) {
            t.hide(this._colGuide);
            t.hide(this._rowGuide);
            var z = this._getGuide(y);
            if (!z) {
                return
            }
            var x = {
            ...
            t.show(z);
            if (z == this._colGuide) {
                x.left = (e[0] - (this._win.pageXOffset || this._doc.documentElement.scrollLeft)).toPx();
                x.width = "2px";
                x.height = this._panel.el.clientHeight.toPx();
                x.background = ""
            } else {
                x.top = (e[1] - (this._win.pageYOffset || this._doc.documentElement.scrollTop)).toPx();
                x.width = this._panel.el.clientWidth.toPx();
                x.height = "2px";
                x.background = ""
            }
            w[A](z);
            this._setGuideStyle(z, x)
        },
        _getType: function(z, e) {
            var x = this.EDGE_TYPE.NONE;
            if (!z) {
                return x
            }
            var w = 5;
            var y = t.getOffset(z);
            if ((e[0] - y.left) < w && z.cellIndex != 0) {
                x = this.EDGE_TYPE.LEFT
            } else {
                if ((y.right - w) < e[0]) {
                    x = this.EDGE_TYPE.RIGHT
                } else {
                    if ((e[1] - y.top) < w && z.parentNode.rowIndex != 0) {
                        x = this.EDGE_TYPE.TOP
                    } else {
                        if ((y.bottom - w) < e[1]) {
                            x = this.EDGE_TYPE.BOTTOM
                        }
                    }
                }
            }
        ...
        _setMouseDownData: function(w, e) {
            this._mouseData.downPoint = e;
            this._mouseData.downTd = w;
            this._mouseData.downType = this._getType(w, e)
        },
        _getTdByEvent: function(w) {
            var x = v.find(t.element(w), "td");
            if (!x || v.find(x, ".txc-info")) {
                return i
            }
            return x
        },
        _minimum: function(A, z) {
            var y = "",
                x = 0;
            var e = this;
            this._switch(z, function() {
                y = "width";
                x = e._MINWIDTH
            }, function() {
                y = "height";
            ...
            var w = A.findAll(function(B) {
                return !!B
            }).map(function(B) {
                return g.TableUtil.getCellOffset(B)[y]
            });
            return (Math.min.apply(Math, w) - x) || 0
        },
        _switch: function(w, e, x) {
            switch (w) {
                case this.EDGE_TYPE.LEFT:
                case this.EDGE_TYPE.RIGHT:
                    e();
        ...
        _calMinMaxPoint: function(D, A, C) {
            var B = this._minimum(D.expandElements, C);
            var z = this._minimum(D.contractElements, C);
            var w = this._subtractPoint(A, this._mouseData.downPoint);
            var e = 0;
            var E = 0;
            this._switch(C, function() {
                e = Math.min(Math.max(w[0] + B, 0), z + B) - B
            }, function() {
                E = Math.min(Math.max(w[1] + B, 0), z + B) - B
            });
            return this._addPoint(this._mouseData.downPoint, [e, E])
        },
        _getTdWidth: function(e) {
            return g.TableUtil.getCellOffset(e).width
        },
        _getTdHeight: function(e) {
            return g.TableUtil.getCellOffset(e).height
        },
        _resize: function(y, e, x) {
            var w = this;
            var z = this._subtractPoint(this._calMinMaxPoint(y, e, x), this._mouseData.downPoint);
            this._switch(x, function() {
                w._resizeWidth(y, z[0])
            }, function() {
                w._resizeHeight(y, z[1])
            });
            this._canvas.history.saveHistory()
        },
        _resizeWidth: function(y, A) {
            var w = this;
            var z = y.expandElements.map(function(e) {
                return w._getTdWidth(e)
            });
            var B = y.contractElements.map(function(e) {
                return w._getTdWidth(e)
            });
            y.expandElements.each(function(D, C) {
                var e = (z[C] + A).toPx();
                D.style.width = e;
                D.width = e
            });
            y.contractElements.each(function(D, C) {
                var e = (B[C] - A).toPx();
                D.style.width = e;
                D.width = e
            });
            if (y.contractElements.length == 0) {
                var x = v.find(y.expandElements[0], "table");
                this._resizeTableWidth(x, A)
            }
        },
        _resizeTableWidth: function(w, x) {
            var e = (Math.min(w.offsetWidth + x, this._canvas.getSizeConfig().contentWidth)).toPx();
            w.width = e;
            w.style.width = e
        },
        _resizeHeight: function(x, z) {
            var w = this;
            var y = x.expandElements.map(function(e) {
                return w._getTdHeight(e)
            });
            var A = x.contractElements.map(function(e) {
                return w._getTdHeight(e)
            });
            x.expandElements.each(function(C, B) {
                var e = (y[B] + z).toPx();
                C.style.height = e;
                C.height = e
            });
            x.contractElements.each(function(C, B) {
                var e = (A[B] - z).toPx();
                C.style.height = e;
                C.height = e
            })
    ...
    g.module("exit Editor", function(B, E, e, x, A) {
        var z = x.getPanel(g.Canvas.__WYSIWYG_MODE);
        var C = z.el;
        var D = A.canvas.exitEditor;

        function w(F) {
            return !(t.getStyle(F, "display") == "none" || t.getStyle(F, "visibility") == "hidden" || F.tagName.toLowerCase() === "input" && F.type == "hidden" || F.tagName.toLowerCase() === "a" && (F.href || "").trim() == "" || F.offsetLeft <= 0)
        }
        ...
        function y(K) {
            try {
                ...
                var I = C;
                var J = "button,a,input,select,object";
                var F = null;
                var G = null;
                do {
                    var H = v.nextContent(I, "#element");
                    if (v.kindOf(H, J)) {
                        F = H
                    } else {
                        G = v.descendants(H, J);
        ...
        C.title = D.desc;
        x.observeKey(D.hotKey, function(F) {
            t.stop(F);
            y(F)
        })
    });
    ...
    g.module("paste anchor controller", function(A, B, C, x, w) {
        g.Paste.AutolinkConverter = g.Class.create({
            initialize: function() {
                this.patternSpace = /\s/;
            ...
            isContainSpace: function(D) {
                return this.patternSpace.test(D.trim())
            },
            isValidUrl: function(D) {
                return !!this.checkValidUrl(D)
            },
            checkValidUrl: function(K) {
                var F = K.trim();
                var E = this.parseUrl(F);
                var I = (E && E.host) || "";
                var J = I.split(".");
                var G = J.length;
                var H = this.patternLikeIP.test(I);
                if (H) {
                    var D = this.patternIPv4.exec(I);
                    if (D && D.length == 5 && D[1] < 256 && D[2] < 256 && D[3] < 256 && D[4] < 256) {
                        return E
                    }
                } else {
                    if (E.scheme && G >= 2) {
            ...
            isAnchorTag: function(D) {
                return this.patternAnchor.test(D.trim())
            },
            parseAnchor: function(E) {
                var D = E.match(this.patternAnchor);
                if (D && D.length == 2) {
                    return D[1]
                }
                return i
            ...
            parseUrl: function(F) {
                var E = this.patternUrl.exec(F.trim());
                var D = {};
                if (E) {
                    D = {
                        url: E[0],
        ...
        var y = A.getPasteCleaner();
        var e = A.getPaster();
        var z = new g.Paste.AutolinkConverter();
        y.addFilter("autolink.control", function(G) {
            var H = e.getMode();
            if (H != g.Paste.MODE_HTML) {
                return G
            }
            t.msie && (G = G.replace(/<meta[^>]*>/gi, ""));
            G = G.trim();
            if (w.toolbar.paste.autolink === u) {
                if (z.isContainSpace(G) == c) {
                    var D = z.checkValidUrl(G);
                    if (D) {
                        var E = G;
                        if (!D.scheme) {
                            E = "http://" + G
                        }
                        G = ['<a target="_blank" href="', E, '" class="tx-link">', decodeURIComponent(G), "</a>"].join("")
                    }
                }
            } else {
                if (w.toolbar.paste.autolink === c) {
                    if (z.isAnchorTag(G)) {
                        var F = z.parseAnchor(G);
                        if (F) {
                            G = F
                        }
                    }
