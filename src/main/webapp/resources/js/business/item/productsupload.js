...
var consts = {
	...
	url: {
		search: null,
		upload: getUrl("/business/item/productsupload/upload.json"),
		remove: getUrl("/business/item/productsupload/save.json"),
		save:   getUrl("/business/item/productsupload/save.json")
	},
	init: function() {
