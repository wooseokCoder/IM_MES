...
/*	cellEdit: true,
	...
	forceFit : true,*/
	url: {
		search: getUrl("/common/user/user/search.json"),
		excel:  getUrl("/common/user/user/download2.do"),
		remove: getUrl("/common/user/user/delete.json"),
		save:   getUrl("/common/user/user/save.json"),
		secure: getUrl("/common/user/user/secure.json"),
