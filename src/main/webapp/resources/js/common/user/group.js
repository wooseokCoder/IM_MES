...
var consts = {
	...
	url: {
		search: getUrl("/common/user/group/search.json"),
		excel:  getUrl("/common/user/group/download.do"),
		save:   getUrl("/common/user/group/save.json")
	},
	init: function() {
...
function doAppend() {
	...
	//appendEdit -> appendEditCustom 으로 변경
	consts.easygrid.appendEditCustom();
}
//삭제 처리
function doRemove() {
	if($('#'+this.id).hasClass('l-btn-disabled')){
	...
	consts.easygrid.removeEditCustom();
}
//저장 처리
function doSave() {
