...
var consts = {
	...
	url: {
		search: getUrl("/common/user/programlistuser/search.json"),
		excel:  getUrl("/common/user/programlistuser/download.do"),
		save:   getUrl("/common/user/userprogramlist/save.json")
	},
	combo: {
...
function doSearch() {
	...
	if($("#progId").combobox('getValue') == ''){
		$.messager.alert('Warning','Please select Prog Name','warning');
		return;
	}
