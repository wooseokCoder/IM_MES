...
var consts = {
	...
	combo: {
		useType: new jcombobox({params:{codeGrup: 'USE_FLAG'}}),
		errType: new jcombobox({params:{codeGrup: 'ERR_PROC'}}),
		grupType: new jcombobox({params:{codeGrup: 'JOB_GRUP'}}),
		jobType: new jcombobox({params:{codeGrup: 'JOB_TYPE'}}),
		cycleType: new jcombobox({params:{codeGrup: 'JOB_CYCLE'}}),
	},

	url: {
		search: getUrl("/common/user/batchwork/search.json"),
		excel:  getUrl("/common/user/batchwork/download.do"),
		save:   getUrl("/common/user/batchwork/save.json")
	},
	init: function() {
		
		//콤보로딩
		this.combo.useType.load();
		this.combo.errType.load();
		this.combo.grupType.load();
		this.combo.jobType.load();
		this.combo.cycleType.load();
