...
var consts = {
	...
	url: {
		search: getUrl("/common/user/personalexcelinfo/search.json"),
		excel:  getUrl("/common/user/personalexcelinfo/download.do"),
		//select: getUrl("/common/personalexcelinfo/select.json"),
		remove: getUrl("/common/user/personalexcelinfo/delete.json"),
		save:   getUrl("/common/user/personalexcelinfo/save.json")
	},
	combo: {
