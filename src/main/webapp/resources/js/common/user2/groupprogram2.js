...
var consts = {
	...
	url: {
		search: getUrl("/common/user2/groupprogram2/search.json"),
		excel:  getUrl("/common/user2/groupprogram2/download.do"),
		save:   getUrl("/common/user2/groupprogram2/save.json")
	},
	init: function() {
