...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.createProgress = function (filedata) {
            ...
            if(s.fileView) {
                pd.fileView.show();
                pd.fileView.click(function () {
                	if(s.fileViewCallback) s.fileViewCallback.call(obj, [filedata]);
				});
            }
        ...
        function createProgressDiv(obj, s) {
            ...
            this.fileView = $("<div class='ajax-file-upload-purple'>" + s.fileViewStr + "</div>").appendTo(this.statusbar).hide();
            if(s.showQueueDiv)
