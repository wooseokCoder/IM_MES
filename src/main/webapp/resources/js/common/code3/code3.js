...
var consts = {
	...
	url: {
		search: getUrl("/common/code3/search.json"),
		excel:  getUrl("/common/code3/download.do"),
		report: getUrl("/common/report/code3."),
		//select: getUrl("/common/code3/select.json"),
		remove: getUrl("/common/code3/delete.json"),
		save:   getUrl("/common/code3/save.json")
	},
	init: function() {
...
//		$('#search-grid').datagrid('hideColumn', 'sortSeq');
...
//		$('#search-grid').datagrid('hideColumn', 'extChr10');
		...
		$('#search-grid').datagrid('hideColumn', 'extText');
		$('#search-grid').datagrid('hideColumn', 'regiId');
		$('#search-grid').datagrid('hideColumn', 'regiDate');
		$('#search-grid').datagrid('hideColumn', 'chngId');
		$('#search-grid').datagrid('hideColumn', 'chngDate');
...
function docheck() {
	var rows = $('#search-create-grid').datagrid('getRows');
		...
		$.ajax({
			url: getUrl('/common/code3/codecheck.json'),
			dataType: 'json',
			async: false,
			type: 'post',
			data: data,
...
function doSaveCreate() {
	...
	$.ajax({
		url: getUrl('/common/code3/updateExtChr.json'),
		dataType: 'json',
		async: false,
		type: 'post',
		data: data,
...
function doSaveCreate2() {
	...
	$.ajax({
		url: getUrl('/common/code3/updateExtNum.json'),
		dataType: 'json',
		async: false,
		type: 'post',
		data: data,
