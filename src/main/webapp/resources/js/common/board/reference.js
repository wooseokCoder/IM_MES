...
jgrid = {
	...
	init: function(args) {
		var cols = [{field:'check',    halign:'center',align:'center',checkbox:true},
		            ...
		            {field:'bordTitle',halign:'center',align:'left',  width:400, title:'제목', sortable:true,data_item:'GRD_002'},
		            //2016/12/22 김영진 -- 파일 첨부 여부
		            {field:'fileCnt',  halign:'center',align:'center',width:40, title:'첨부', data_item:'GRD_008', formatter:jformat.filecnt},
		            //{field:'bordBgn',  align:'center',width: 120, title:'시작일'},
		            //{field:'bordEnd',  align:'center',width: 120, title:'종료일'},
		            {field:'readCnt',  halign:'center',align:'right', width: 80, title:'조회수',sortable:true, data_item:'GRD_003'},
		            {field:'regiName', halign:'center',align:'center',width: 80, title:'등록자',sortable:true, data_item:'GRD_004'},
		            {field:'regiDate', halign:'center',align:'center',width:130, title:'등록일자',sortable:true, data_item:'GRD_005'},
		            {field:'chngName', halign:'center',align:'center',width: 80, title:'수정자',sortable:true, data_item:'GRD_006'},
		            {field:'chngDate', halign:'center',align:'center',width:130, title:'수정일자',sortable:true, data_item:'GRD_007'}];
...
consts = {
	...
	url: {
		search: getUrl("/common/board/reference/search.json"),
		excel:  getUrl("/common/board/reference/download.do"),
		select: getUrl("/common/board/reference/select.json"),
		remove: getUrl("/common/board/reference/delete.json"),
		save:   getUrl("/common/board/reference/save.json"),
		form:   getUrl("/common/board/reference/form.do"),
		view:   getUrl("/common/board/reference/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
