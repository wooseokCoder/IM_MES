...
consts = {
	...
	url: {
		search: getUrl("/common/board/qna/search.json"),
		excel:  getUrl("/common/board/qna/download.do"),
		select: getUrl("/common/board/qna/select.json"),
		remove: getUrl("/common/board/qna/delete.json"),
		save:   getUrl("/common/board/qna/save.json"),
		form:   getUrl("/common/board/qna/form.do"),
		view:   getUrl("/common/board/qna/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
