...
jgrid = {
	...
	init: function(args) {
		...
		var cols = [{field:'check',     halign:'center',align:'center',checkbox:true},
		            {field:'BORDNO1',   halign:'center',align:'left',width:300, title:'No', sortable:true, data_item:"GRD_001"},
		            {field:'BORDTITLE1',halign:'center',align:'left',  width:300, title:'Title', sortable:true, data_item:"GRD_002"},
		            ...
		            {field:'regiDate',  halign:'center',align:'center',width:140, title:'Write date', data_item:"GRD_005"},
		            {field:'chngName',  halign:'center',align:'center',width:120, title:'Updater', data_item:"GRD_006"},
		            {field:'chngDate',  halign:'center',align:'center',width:140, title:'Update date', data_item:"GRD_007"},
...
consts = {
	...
	formKey: "hidden-form",
	url: {
		search: getUrl("/common/board/navHelp/search.json"),
		excel:  getUrl("/common/board/navHelp/download.do"),
	...
	    var _top = Math.ceil(( window.screen.height - _height )/2); 
		...
		let menualUrl = "/common/board/navHelp/view.do";
		let menualPop = window.open(context + menualUrl + '?bordNo='+row.bordNo, 'menual_'+row.bordNo,'width='+ _width +',height='+ _height +',left=' + _left + ',top='+ _top);
