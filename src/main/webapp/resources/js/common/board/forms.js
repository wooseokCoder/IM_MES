...
jgrid = {
	...
	init: function(args) {
		...
		var cols = [{field:'check',    halign:'center',align:'center',checkbox:true},
		            ...
		            {field:'bordTitle',halign:'center',align:'left',  width:640, title:'Title', sortable:true, data_item:"GRD_002"},
...
consts = {
	...
	formKey: "hidden-form",
	url: {
		search: getUrl("/common/board/forms/search.json"),
		excel:  getUrl("/common/board/forms/download.do"),
		select: getUrl("/common/board/forms/select.json"),
		remove: getUrl("/common/board/forms/delete.json"),
		form:   getUrl("/common/board/forms/form.do"),
		view:   getUrl("/common/board/forms/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
