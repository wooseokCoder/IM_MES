...
consts = {
	...
	url: {
		search: getUrl("/common/board/alter/search.json"),
		excel:  getUrl("/common/board/alter/download.do"),
		select: getUrl("/common/board/alter/select.json"),
		remove: getUrl("/common/board/alter/delete.json"),
		save:   getUrl("/common/board/alter/save.json"),
		form:   getUrl("/common/board/alter/form.do"),
		view:   getUrl("/common/board/alter/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
