/**
 * Sales Information을 처리하는 스크립트이다.
 *
 * 그리드 검색 및 페이징
 * 등록,수정,삭제 페이지이동 처리
 */
...
consts = {
	...
	formKey: "hidden-form",
	url: {
		search: getUrl("/common/board/saleinfo/search.json"),
		excel:  getUrl("/common/board/saleinfo/download.do"),
		select: getUrl("/common/board/saleinfo/select.json"),
		remove: getUrl("/common/board/saleinfo/delete.json"),
		form:   getUrl("/common/board/saleinfo/form.do"),
		view:   getUrl("/common/board/saleinfo/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
