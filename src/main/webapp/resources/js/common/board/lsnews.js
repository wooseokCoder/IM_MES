...
consts = {
	...
	formKey: "hidden-form",
	url: {
		search: getUrl("/common/board/lsnews/search.json"),
		excel:  getUrl("/common/board/lsnews/download.do"),
		select: getUrl("/common/board/lsnews/select.json"),
		remove: getUrl("/common/board/lsnews/delete.json"),
		form:   getUrl("/common/board/lsnews/form.do"),
		view:   getUrl("/common/board/lsnews/view.do")
	},
	params: {
		oper: jstatus.INSERT,
		sysId:    null,
