...
jgrid = {
	...
	init: function(args) {
		...
		var cols = [{field:'check',    halign:'center',align:'center',checkbox:true},
		            ...
		            {field:'readCnt',  halign:'center',align:'right', width: 80, title:'View', data_item:"GRD_005"},
		            {field:'regiName', halign:'center',align:'center',width: 80, title:'Writer', data_item:"GRD_006"},
