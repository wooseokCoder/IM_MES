...
jgrid = {
	...
	init: function(args) {
		...
		var cols = [{field:'check',     halign:'center',align:'center',checkbox:true},
		            ...
		            {field:'replyCnt',  halign:'center',align:'center',width: 60, title:'Reply',data_item:'GRD_004'},
		            {field:'regiName',  halign:'center',align:'center',width:120, title:'Writer', data_item:"GRD_005"},
		            {field:'regiDate',  halign:'center',align:'center',width:130, title:'Write date', data_item:"GRD_006"},
		            {field:'chngName',  halign:'center',align:'center',width:120, title:'Updater', data_item:"GRD_007"},
		            {field:'chngDate',  halign:'center',align:'center',width:130, title:'Update date', data_item:"GRD_008"},
		            {field:'fileCnt',   halign:'center',align:'center',width:50,  title:'Att', data_item:'GRD_009', formatter:jformat.filecnt}];
...
consts = {
	...
	formKey: "hidden-form",
	url: {
		search: getUrl("/common/board/lsqna/search.json"),
		excel:  getUrl("/common/board/lsqna/download.do"),
