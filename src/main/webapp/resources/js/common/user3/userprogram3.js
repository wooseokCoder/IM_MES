...
var consts = {
	...
	url: {
		search: getUrl("/common/user3/userprogram3/search.json"),
		excel:  getUrl("/common/user3/userprogram3/download.do"),
		save:   getUrl("/common/user3/userprogram3/save.json")
	},
	combo: {
...
function doAppend() {
	...
	//추가데이터 가져오기
	var obj = jsystem.appendSingle(rows);
