...
var consts = {
	...
	url: {
		search: getUrl("/common/user3/groupprogram3/search.json"),
		excel:  getUrl("/common/user3/groupprogram3/download.do"),
		save:   getUrl("/common/user3/groupprogram3/save.json")
	},
	combo: {
