...
function windowResizing(){
	...
	if(tempUrl.substring(tempUrl.lastIndexOf("/")+1,tempUrl.length) != 'address.do' &&
			...
			tempUrl.substring(tempUrl.lastIndexOf("/")+1,tempUrl.length) != 'ndmordercreate.do'&&
			tempUrl.substring(tempUrl.lastIndexOf("/")+1,tempUrl.length) != 'ndmorderview.do'&&
			tempUrl.substring(tempUrl.lastIndexOf("/")+1,tempUrl.length) != 'ndmorderadmin.do'){
