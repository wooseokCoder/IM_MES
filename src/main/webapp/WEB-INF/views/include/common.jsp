...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/common.css?v=260310A" />" />
...
<script type="text/javascript" src="<c:url value="/resources/js/include/widget.js?v=260318A"    />"></script>
