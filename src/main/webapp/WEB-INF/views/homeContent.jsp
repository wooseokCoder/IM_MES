...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<%-- @(#)homeContent.jsp 1.0 2026/02/26                                    --%>
<%--                                                                        --%>
<%-- Home 탭 대시보드 콘텐츠 (iframe 내 렌더링용)                           --%>
...
<meta name="viewport"
	...
	<script type="text/javascript"
		src="<c:url value="/resources/js/index.js?v=260226A" />"></script>

	<!-- iframe 내에서 메뉴 이동은 부모 프레임으로 위임 -->
	<script type="text/javascript">
		// index.js의 doMemuGo를 부모 프레임 위임으로 오버라이드
...
.notification-container {
	...
	<div class="easyui-layout" data-options="fit:true" style="padding: 0px 16px;">
		...
		<div class="header" style="padding-top: 16px; ">
			...
			<div>
				<div style="margin-left: 16px;">
					<span style="font-size: 20px; font-weight: 600; color: #1f1f1f;">${user.userName}</span>
