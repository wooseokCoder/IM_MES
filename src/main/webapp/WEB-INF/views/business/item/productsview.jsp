...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/business/item/productsview.js" />"></script>
<script>
var getParameters="";
var limitNo="";
var printType="";
...
function openPrintDetail(){
	...
	case 'modelNo':
		if($("#r_modelNo").val()!=""){
			$("#PbarcodeNo").textbox('setValue',$("#r_modelNo").val());
		}else{
...
<div class="easyui-layout" data-options="fit:true" id="account-layout" style="display:none">
					...
					<td>
						<div class="search-table-react">
							<div class="search-table-category">
								<span class="search-table-h" data-item="LAB_001">품명/규격</span>
							...
							<div class="search-table-category">
								<span class="search-table-h" data-item="LAB_002">품번</span>
	...
	<table id="search-grid">
		<thead>
				<tr>
				<th data-options="field:'itemCode'     , halign:'center',width:120, data_item:'GRD_001', align:'center', sortable:true">품번</th>
				<th data-options="field:'itemName'     , halign:'center',width:300, data_item:'GRD_002', align:'left', sortable:true ">품명</th>
				<th data-options="field:'itemSpec'     , halign:'center',width:300, data_item:'GRD_003', align:'left', sortable:true ">규격</th>
				<th data-options="field:'itemType1Name', halign:'center', width:120, data_item:'GRD_004', align:'center',sortable:true">1차</th>
				<th data-options="field:'itemType2Name', halign:'center', width:120, data_item:'GRD_005', align:'center',sortable:true">2차</th>
			</tr>
		</thead>
	</table>
	</div>
...
<!-- [EAST] start -->
	    <div data-options="region:'east',border:false" style="padding-top:24px; padding-bottom:40px;width:580px;">
			<div class="accountInfo-header" style="border-bottom:1px solid #8a8a8a;margin-left:10px;width:570px;"><span data-item="LAB_005">상세정보</span></div>
			    	...
			    	<fieldset style="border-right:1px solid #dadada;">
				        ...
				        <table class="company-info-table adjust-table1" style="margin-left:10px;border-left:1px solid #dadada">
				            ...
				            <tr style="border-collapse:collapse; border:none;">
								...
								<span data-item="LAB_006">품번</span>
								</span>
								</th>
								<td class="textfix" style="border-right:1px solid #ccc;"><input type="text" class="easyui-textbox txt-center" name="itemCode" id="r_itemCode" data-options="readonly:true"/></td>
				          		<td colspan="2" >
				          			<span data-item="LAB_007"> * 품번은 자동으로 생성됩니다.</span>									
								</td>
				            </tr>
						...
						<td class="d">
				           ...
				           <tr>
				            ...
				            <tr>
								...
								<th><span data-item="LAB_019">매출단가</span></th>
								<td>
...
<div id="item-search-dialog" class="wui-dialog" style="border-top-width:1px;display:none">
	<table id="search-item-grid">
		<thead>
			<tr>
				<th data-options="field:'itemCode', halign:'center', align:'center', width:110, data_item:'GRD_006'">품번</th>
				<th data-options="field:'itemName', halign:'center', width:190, data_item:'GRD_007'">품명</th>
				<th data-options="field:'itemSpec', halign:'center', align:'left', width:190, data_item:'GRD_008'">규격</th>
		...
		<form id="search-item-form">
			<fieldset class="div-line-new" style="text-align:center;">
		        <table cellpadding="0" class="search-table tableSearch-c wd-100" style="display:inline-block;">
		            ...
		            <tr>
						<th class="h table-Search-h search-label-h" data-item = 'LAB_26'><span>상품명 </span></th>
						<td class="d">
						...
						<th class="h table-Search-h search-label-h" data-item = 'LAB_27'><span>모델/규격명 </span></th>
						<td class="d">
							<input class="easyui-textbox" name="pmodelName" id="pmodelName" style="width:150px"/>
						</td>
						<td class="b">
							<a href="javascript:void(0)" id="search-item-pop-button" class="easyui-linkbutton cgray" data-item = 'BTN_7'>조회</a>
						</td>
					</tr>
					<tr>
						<th class="h table-Search-h search-label-h"><span data-item = 'LAB_28'>1차 구분명</span></th>
						<td class="d">
						...
						<th class="h table-Search-h search-label-h"><span data-item = 'LAB_29'>2차 구분명</span></th>
						<td class="d">
