...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<%-- @(#)homeContent02.jsp 1.0 2026/02/26                                  --%>
<%--                                                                        --%>
<%-- Home 탭 대시보드 콘텐츠 - DT02 (iframe 내 렌더링용)                    --%>
<%-- index.jsp의 탭 시스템 내 Home 탭에서 iframe으로 로딩됨                 --%>
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
...
<meta name="viewport"
	...
	<link rel="stylesheet" type="text/css"
		href="<c:url value="/resources/css/index.css?v=260226A" />" />
	<script type="text/javascript" src="<c:url value="/resources/js/chartjs/Chart.bundle.js" />"></script>

	<!-- BUSINESS JAVASCRIPT (index02.js loads menus/hotmenus/popups) -->
	<script type="text/javascript" src="<c:url value="/resources/js/index02.js?v=260226A" />"></script>

	<!-- iframe 내에서 메뉴 이동은 부모 프레임으로 위임 -->
	<script type="text/javascript">
		// index02.js의 doMemuGo를 부모 프레임 위임으로 오버라이드
		function doMemuGo(key) {
			if (parent && parent.jmenus) {
				parent.jmenus.go(key);
			}
		}
	</script>
		...
		<div class="header" style="padding-top: 16px; ">
			...
			<div>
				<div style="margin-left: 16px;">
					<span style="font-size: 20px; font-weight: 600; color: #6f5252;">${user.userName}</span>
