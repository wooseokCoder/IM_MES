...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/imes/pop/pop57a.js"/>?v=260312A"></script>
...
<div data-options="region:'center', border:false">
    <div class="easyui-layout" data-options="fit:true">
        <!-- 좌측: 설비 그리드 -->
        <div data-options="region:'west', split:true, collapsible:false, border:true" style="width:30%;">
            <table id="machine-grid"></table>
        </div>
