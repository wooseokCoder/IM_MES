...
<table id="search-grid">
	<thead data-options="frozen:true">
		<tr>
			<th data-options="field:'codeCd',   halign:'center', width:100, editor:{type:'validatebox',options:{required:true}}, sortable:true,data_item:'GRD_001'">Service manager</th>
<!-- 			<th data-options="field:'codeNameKr', halign:'center', width:150, editor:{type:'validatebox',options:{required:true}}, sortable:true,data_item:'GRD_002'">Code Name</th>
	...
	<thead>
		<tr>
			...
			<th data-options="field:'codeDesc', halign:'center',width:250, editor:{type:'validatebox'},data_item:'GRD_006'">E-mail</th>
	        		...
	        		<td colspan="8">
	        			<div>
	        				...
	        				<div>
	        					...
	        					<a href="javascript:void(0)" style="width: 80px;" class="easyui-linkbutton cgray" id="sort-button"  data-item="BTN_002">Sort</a>
...
<%-- 					<th class="h table-Search-h-right search-label-h" data-item="LAB_001"><span>Code Group </span></th>
					<td class="d">
						<select class="easyui-combobox" name="codeGrup" ID="s_codeGrup" data-options="width:180,height:30">
	            ...
	            <tr>
					<td class="h">
					    ...
					    <a href="javascript:void(0)" class="easyui-linkbutton c4" id="report-button-pdf" data-item="BTN_009">
					    	Print&nbsp;
					    	<img style="width:16px; height:16px;" src="<%=request.getContextPath() %>/resources/images/icon_new/print.png" />
					    </a>
						</div>
					</td>
	            </tr>
