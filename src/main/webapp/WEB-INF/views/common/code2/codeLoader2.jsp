...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/code2/codeLoader2.js" />"></script>
</head>
...
<div id="search-toolbar" class="wui-toolbar">
	        ...
	        <table cellpadding="5" class="search-table">
	            <tr>
					...
					<td class="d">
					    ...
					    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok"    id="upload-button">업로드</a>
					    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-clear" id="clear-button" >초기화</a>
					</td>
	            </tr>
	        </table>
		</fieldset>
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true"   id="save-button"  >저장</a>
</div>
