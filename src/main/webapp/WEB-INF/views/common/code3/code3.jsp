...
<table id="search-grid">
	...
	<thead>
		<tr>
			...
			<th data-options="field:'extChr01', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_007'">Ext01</th>
			<th data-options="field:'extChr02', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_008'">Ext02</th>
			<th data-options="field:'extChr03', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_009'">Ext03</th>
			<th data-options="field:'extChr04', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_010'">Ext04</th>
			<th data-options="field:'extChr05', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_011'">Ext05</th>
			<th data-options="field:'extChr06', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_012'">Ext06</th>
			<th data-options="field:'extChr07', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_013'">Ext07</th>
			<th data-options="field:'extChr08', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_014'">Ext08</th>
			<th data-options="field:'extChr09', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_015'">Ext09</th>
			<th data-options="field:'extChr10', halign:'center',width:100, editor:{type:'validatebox'},data_item:'GRD_016'">Ext10</th>
			<th data-options="field:'remk', halign:'center',width:350, data_item:'GRD_008',align:'center'"></th>
	        ...
	        <table cellpadding="5" class="search-table tableEtc-c">
	            <tr>
					<td class="h">
				    	...
				    	<%-- <a href="javascript:void(0)" class="easyui-linkbutton c6" id="extChr-button" data-item="BTN_008" data-options="disabled:${UPD}">Extension</a>
					    <a href="javascript:void(0)" class="easyui-linkbutton c6" id="extNum-button" data-item="BTN_008" data-options="disabled:${UPD},width:90">Extension2</a> --%>
					    <a href="javascript:void(0)" class="easyui-linkbutton c4" iconCls="" id="excel-button" data-item="BTN_006">Excel Download&nbsp;
							<img src="<%=request.getContextPath() %>/resources/images/icon_new/excel_download.png" />
						</a>
					    <a href="javascript:void(0)" class="easyui-linkbutton btn_print" iconCls=""  id="report-button-pdf" data-item="BTN_007" >Print&nbsp;
				...
				<table class="popup-search-table">
		            ...
		            <tr style="border-top-style:inset;border-top-color:#00000;border-top-width:2px;">
						<td class="d popup-table-alignCenter" colspan="2" style="padding-top: 10px;">
							<a href="javascript:void(0)" class="easyui-linkbutton c6" id="save-create-button" data-item="BTN_011" data-options="disabled:${UPD}" >Save</a>
					    	<a href="javascript:void(0)" class="easyui-linkbutton c6" id="close-create-button" data-item="BTN_012">Close</a>
						</td>
		            </tr>
		        </table>
			</div>
		...
		<fieldset class="div-line-new-sub">
			<div class="popup-table-alignCenter">
				<table class="popup-search-table">
		            ...
		            <tr style="border-top-style:inset;border-top-color:#00000;border-top-width:2px;">
						<td class="d popup-table-alignCenter" colspan="2" style="padding-top: 10px;">
							<a href="javascript:void(0)" class="easyui-linkbutton c6" id="save-create-button2" data-item="BTN_011" data-options="disabled:${UPD}" >Save</a>
					    	<a href="javascript:void(0)" class="easyui-linkbutton c6" id="close-create-button2" data-item="BTN_012">Close</a>
						</td>
		            </tr>
		        </table>
			</div>
