...
<form id="select-form" method="post">
	...
	<fieldset>
		...
		<table class="adjust-select">
			<tr>
				<th><span data-popup="POP_LAB_004">제목</span>${model.button_stts}</th>
			...
			<tr>
				<th><span data-popup="POP_LAB_005">받는사람</span></th>
				<td><span id="v_tgtUserId"></span></td>
				<th><span data-popup="POP_LAB_006">발송일자</span></th>
		...
		<div class="easyui-panel wui-tareas" style="height:320px;">
...
$(function() {
	...
	$('#dialog-button-viewReply').css("display", "none");
