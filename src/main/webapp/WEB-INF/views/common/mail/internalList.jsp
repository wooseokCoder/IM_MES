...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/mail/internallist.js" />"></script>
	 ...
	 $(function(){
		 ...
		 $("#append-button").click(function(){
			 ...
			 if(window.innerWidth<1400){
		 			...
		 			//alert("call");
		 			$(".window #regist-dialog").css("height",390);
		 			$("#regist-form fieldset").css("height",370);
		 			...
		 			$("#select-form fieldset").css("height",370);
		 			$(".window-shadow").css("height",390);
		 			$("#select-form fieldset").css("overflow-y","scroll");
		 			$("#select-form fieldset").css("overflow-x","hidden");
...
#select-dialog #select-form fieldset{height:380px !important; overflow:auto;}
#select-dialog{height:390px !important;}
...
<div id="search-toolbar" class="wui-toolbar">
	...
	<form id="search-form">
		<fieldset class="div-line-new" style="padding:8px 0px 10px 5px;">
			<input type="hidden" name="addrType" id="addrType"   value="internalList" />
			...
			<input class="easyui-combobox" name="searchKey"  id="s_searchKey"  value="S01" codeGrup="INTERNAL_STYPE" data-options="mode:'remote',width:100,editable:false,loader:jcombo.loader,panelHeight:'auto'"/>
	...
	<fieldset class="div-line-new-sub">
		<table>
			<tr>
				<td><a href="javascript:void(0)" class="easyui-linkbutton c6 l-btn l-btn-small" style="margin-right:3px;" id="remove-button" data-item="BTN_002">삭제</a></td>
				<td><a href="javascript:void(0)" class="easyui-linkbutton c4 l-btn l-btn-small" iconCls="icon-excel" id="excel-button" data-item="BTN_003">엑셀</a></td>
