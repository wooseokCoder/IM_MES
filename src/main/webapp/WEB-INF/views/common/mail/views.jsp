...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/mail/views.js" />"></script>
...
<input type="hidden" name="text_menuKey" id="text_menuKey" value="${menuKey}"/>
	<table id="search-grid">
		<thead>
			<tr>
				<th data-options="field:'tgtUserId', width:150, halign:'center', align:'center', sortable:true, data_popup:'POP_GRD_003'">수신자</th>
	...
	<div id="search-toolbar" class="wui-toolbar">
		<form id="search-form">
			<fieldset>
				...
				<a href="javascript:void(0)" class="easyui-linkbutton cgray l-btn l-btn-small" id="search-button" data-popup="POP_BTN_007">검색</a>
			</fieldset>
		</form>
	</div>
