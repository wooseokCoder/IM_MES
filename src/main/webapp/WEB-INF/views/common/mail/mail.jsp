...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/mail/mail.js" />"></script>
...
<style>
.window #regist-dialog{heidht:523px;}
...
<div id="search-toolbar" class="wui-toolbar">
    ...
    <fieldset class="div-line-new-sub">
		<table>
			<tr>
				<td><a href="javascript:void(0)" class="easyui-linkbutton c6 l-btn l-btn-small" style="margin-right:3px;" id="append-button" data-item="BTN_002">메일작성</a></td>
				<td><a href="javascript:void(0)" class="easyui-linkbutton c6 l-btn l-btn-small" style="margin-right:3px;" id="remove-button" data-item="BTN_004">삭제</a></td>
