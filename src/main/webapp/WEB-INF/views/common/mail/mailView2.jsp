...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<style>
#select-dialog .panel-header{color:#000 !important; border-bottom:1px solid #ccc !important;border-top:1px solid #ccc !important;}
...
<form id="select-form" method="post">
	...
	<fieldset>
		...
		<input type="hidden" name="userId"   id="v_userId"   value="${userId}"/>
		
		<table class="adjust-select">
			<tr>
				<th width="12%" ><span data-popup="POP_LAB_001">제목</span>${model.button_stts}</th>
				<td width="88%" colspan="3"><span id="v_bordTitle"></span></td>
			</tr>
			<tr>
				<th><span data-popup="POP_LAB_002">보낸사람</span></th>
				<td width="35%"><span id="v_regiId"></span></td>
				<th style="width:12% !important;" ><span data-popup="POP_LAB_003">발송일자</span></th
		...
		<div class="easyui-panel wui-tareas" title="내용" style="height:320px;">
			<span id="v_bordText"></span><img id="readView" style="display:none;" width="0" height="0" src="" />
		</div>
...
$(function() {
	...
	$('#dialog-button-viewUpdate').css("display", "none");
	$('#dialog-button-viewDelete').css("display", "none");
	$('#dialog-button-Close span span').html("닫기");
	$('#readView').attr("src", "http://180.70.123.37:2020/wsc/common/mail/read.do?bordNo=" + $('#v_bordNo').val() + "&userId=" + $('#v_userId').val() + "&bordGrup=" + $('#v_bordGrup').val());
