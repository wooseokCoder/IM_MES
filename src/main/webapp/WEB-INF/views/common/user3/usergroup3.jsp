...
<script type="text/javascript" src="<c:url value="/resources/js/common/user3/usergroup3.js" />"></script>
</head>
...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'center',border:false">
		...
		<table id="search-grid">
			<thead>
				<tr>
					<th data-options="field:'userId',   width:100, data_item:'GRD_007', sortable:true">사용자ID</th>
					<th data-options="field:'userName', width:150, data_item:'GRD_008', sortable:true">사용자명</th>
					<th data-options="field:'groupId2', width:150, data_item:'GRD_009', sortable:true">그룹ID</th>
					<th data-options="field:'groupId',  width:150, data_item:'GRD_010', sortable:true, editor:consts.combo.groupId.editor(),formatter:consts.combo.groupId.formatter()">그룹명</th>
					<th data-options="field:'regiId',   width: 80, data_item:'GRD_011'">등록자ID</th>
					<th data-options="field:'regiDate', width:130, data_item:'GRD_012'">등록일시</th>
					<th data-options="field:'chngId',   width: 80, data_item:'GRD_013'">수정자ID</th>
					<th data-options="field:'chngDate', width:130, data_item:'GRD_014'">수정일시</th>
				</tr>
			</thead>
		</table>
