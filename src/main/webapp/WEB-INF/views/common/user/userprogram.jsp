...
<script type="text/javascript" src="<c:url value="/resources/js/common/user/userprogram.js" />"></script>
</head>
	...
	<form id="search-form">
		<fieldset class="Remake-div-line-new ">
            <table cellpadding="7" class="search-table tableSearch-c wd-100">
	            ...
	            <tr>
					<th class="h table-Search-h-right search-label-h" data-item="LAB_001"><span>User Name </span></th>
					<td class="d">
						<select class="easyui-combobox" name="userId" ID="userId" data-options="width:300">
		...
		<table id="search-grid">
			<thead>
				<tr>
					...
					<!-- <th data-options="field:'progName', width:150, sortable:true">화면명</th> -->
					...
					<!-- <th data-options="field:'tran1',    width:45,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran">권한1</th>
					<th data-options="field:'tran2',    width:45,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran">권한2</th>
					<th data-options="field:'tran3',    width:45,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran">권한3</th>
					<th data-options="field:'tran4',    width:45,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran">권한4</th>
					<th data-options="field:'tran5',    width:45,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran">권한5</th> -->
