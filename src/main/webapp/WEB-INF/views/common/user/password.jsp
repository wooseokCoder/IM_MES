...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/user/password.js?v=0626A" />"></script>
		...
		<table class="changePw-table">
			<tr style="background:#0e4f87">
				<td class="changePw-title">
					<span data-item="LAB_001">Reset Password</span>
				</td>
			</tr>
			<tr>
				<td class="changePw-center changePw-img">
					<img src="<c:url value="/resources/images/password.jpg" />" alt="Reset Password"  style="width:90px;height:110px;" />
				</td>
			</tr>
			<tr>
				<td class="changePw-tdH changePw-tdPd"><span data-item="LAB_002">User ID</span><span style="color:red;">*</span></td>
			</tr>
			<tr>
				<td class="changePw-tdH changePw-tdPd"><input type="text" name="userId" id="userId" style="width:100%;" /></td>
			</tr>
			<tr>
