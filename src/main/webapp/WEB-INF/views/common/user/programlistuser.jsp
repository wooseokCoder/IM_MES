...
<div id="search-toolbar" class="wui-toolbar">
	...
	<form id="search-form">
		...
		<table id="search-grid">
			<thead>
				<tr>
					<th data-options="field:'userId',   width:150, sortable:true,data_item:'GRD_001'">User ID</th>
					<th data-options="field:'userName', width:150, sortable:true,data_item:'GRD_002'">User Name</th>
					<th data-options="field:'orgAuth',  width:100, sortable:true,data_item:'GRD_003'">Org Auth</th>
					<th data-options="field:'tranA',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_005'" formatter="formatCheck">BAS</th>
					<th data-options="field:'tranC',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_006'" formatter="formatCheck">INS</th>
					<th data-options="field:'tranR',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_007'" formatter="formatCheck">RET</th>
					<th data-options="field:'tranU',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_008'" formatter="formatCheck">UPD</th>
					<th data-options="field:'tranD',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_009'" formatter="formatCheck">DEL</th>
					<th data-options="field:'tranP',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_010'" formatter="formatCheck">ASP</th>
					<th data-options="field:'tranS',    width:90,align:'center',editor:{type:'checkbox',options:{on:'1',off:'0'}},formatter:jformat.tran,data_item:'GRD_011'" formatter="formatCheck">ASS</th>
					<th data-options="field:'regiId',   width:100,data_item:'GRD_012'">Regi ID</th>
					<th data-options="field:'regiDate', width:160,data_item:'GRD_013'">Regi Date</th>
					<th data-options="field:'chngId',   width:100,data_item:'GRD_014'">Chng ID</th>
					<th data-options="field:'chngDate', width:160,data_item:'GRD_015'">Chng Date</th>
				</tr>
			</thead>
		</table>
