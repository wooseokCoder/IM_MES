...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/formsView.js" />"></script>
...
<div class="easyui-layout" data-options="fit:true" id="account-layout" style="display:none">
		...
		<div class="easyui-panel" data-options="title:fit:true">
		    ...
		    <div style="text-align:center;padding:5px">
		        <a href="javascript:void(0)" class="easyui-linkbutton c6" id="update-button" data-item="BTN_008" data-options="disabled:${UPD}" >Modify</a>
