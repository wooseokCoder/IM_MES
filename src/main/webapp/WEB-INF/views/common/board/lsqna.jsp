...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/lsqna.js?v=0627A" />"></script>
		...
		<table  cellpadding="5" class="search-table tableEtc-c" style="width:100%;">
			<tr>
				<td class="h" style="width:500px; min-width: 200px;">
					<a href="javascript:void(0)" class="easyui-linkbutton c6" id="regist-button" data-item="BTN_002" data-options="disabled:${INS}">
						Write
					</a>
				    <a href="javascript:void(0)" class="easyui-linkbutton c6" id="remove-button" data-item="BTN_003" data-options="disabled:${DEL}">
				    	Delete
				    </a>
				...
				<td class="h etctext" style="text-align:right;" data-item="TXT_001"><span data-item="LAB_001">For more information, double click on the line.</span></td>
			</tr>
		</table>
	</fieldset>
</div>
