...
<form id="regist-form" method="post">
	...
	<fieldset>
		...
		<table cellpadding="5" cellspacing="2" class="select-table accordion">
			...
			<tr>
				<th style="width:50px" class="nhstyle" data-popup="POP_LAB_001"><p class="essential"></p><span>메뉴</span></th>
				<td>
			...
			<tr>
				<th style="width:50px" class="nhstyle" data-popup="POP_LAB_002"><p class="essential"></p><span>날짜</span></th>
				<td>
