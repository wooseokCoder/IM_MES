...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<%-- @(#)navHelpView.jsp 1.0 2025/10/23                                     --%>
<%--                                                                        --%>
...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/navHelpView.js" />"></script>
...
<div class="easyui-layout" data-options="fit:true" id="account-layout" style="display:none; padding: 10px;">
		...
		<div class="easyui-panel" data-options="fit:true">
		    ...
		    <div style="text-align:center;padding:20px"> <!-- 관리자일 경우에만 보여야함 -->
