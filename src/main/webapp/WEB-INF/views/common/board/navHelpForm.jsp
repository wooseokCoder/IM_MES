...
<%-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ --%>
<%-- @(#)navHelpForm.jsp 1.0 2025/10/23                                     --%>
<%--                                                                        --%>
...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/navHelpForm.js" />"></script>
...
<%@ include file="/WEB-INF/views/include/body.head.jsp" %>
		...
		<div id="regist-panel" class="easyui-panel brd_edit_h" data-options="fit:true" style="padding: 10px;">
		    <form id="regist-form" method="post">
		    	<fieldset>
					...
					<input type="hidden" name="bordEnd"  id="r_bordEnd"  value="12-31-9999"/>
					
					<input type="hidden" name="menuKey" id="r_menuKey" value="${model.menuKey}"/>
					
					<!-- <input type="hidden" name="h_thumbnail" id="h_thumbnail"  value=""/> -->
					<table class="adjust-select">
						...
						<tr>
							...
							<td width="88%">
								<!-- <input class="easyui-textbox" name="bordTitle" id="r_bordTitle" style="width:100%" data-options="required:true,validType:'length[0,100]'" readOnly/> -->
								<span id="bordTitleSpan">${model.bordTitle}</span>
								<input type="hidden" name="bordTitle" id="r_bordTitle" value="" />
								<input type="hidden" name="bordTitleTemp" id="r_bordTitleTemp" value="${model.bordTitle}" />
								<!-- <input class="easyui-textbox" name="bordTitle" id="r_bordTitle" style="width:100%" data-options="required:true,validType:'length[0,100]'"/> -->
							</td>
						</tr>
						<tr>
		    ...
		    <div style="text-align:center;padding:20px">
		        ...
		        <c:if test="${model.oper != 'I'}">
		        	...
		        	<a href="javascript:void(0)" class="easyui-linkbutton c6"  id="view-button" >View</a>
		        </c:if>
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="close-button"  >Close</a>
