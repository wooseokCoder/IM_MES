	...
	<fieldset>
		...
		<table class="adjust-select">
			<tr>
				...
				<td colspan="3" class="nhstyle nstyle"><span id="v_bordTitle"></span>
			...
			<tr>
				<th data-popup="POP_LAB_004"><span>작성자 :</span></th><td class="nhstyle nstyle"><span id="v_regiName"></span></td>
				<th data-popup="POP_LAB_005"><span>조회수 :</span></th><td class="nhstyle nstyle"><span id="v_readCnt"></span></td>
			</tr>
			<tr>
				<th data-popup="POP_LAB_006"><span>시작일 :</span></th><td class="nhstyle nstyle"><span id="v_bordBgn"></span></td>
				<th data-popup="POP_LAB_007"><span>종료일 :</span></th><td class="nhstyle nstyle"><span id="v_bordEnd"></span></td>
			</tr>
			<!-- 
			<tr>
			 ...
			 -->
			<tr>
				<th class="nhstyle nstyle" data-popup="POP_LAB_008"><span>등록일 :</span></th><td  class="nhstyle nstyle"><span id="v_regiDate"></span></td>
				<th class="nhstyle nstyle" data-popup="POP_LAB_009"><span>수정일 :</span></th><td  class="nhstyle nstyle"><span id="v_chngDate"></span></td>
			</tr>
		</table>
		<div class="easyui-panel wui-tareas" title="내용" style="height:250px;padding:10px;">
