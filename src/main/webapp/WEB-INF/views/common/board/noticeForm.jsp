...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/noticeForm.js" />"></script>
...
<%@ include file="/WEB-INF/views/include/body.head.jsp" %>
		...
		<div id="regist-panel" class="easyui-panel" data-options="title:' ',fit:true,iconCls:'icon-edit'">
		    ...
		    <form id="regist-form" method="post">
		    	...
		    	<fieldset>
					...
					<table class="adjust-select">
						<tr>
							<th width="12%"><span data-item="LAB_001">게시기간</span></th>
						...
						<tr>
							<th style="width:80px"><span data-item="LAB_002">공지제목</span></th>
							<td><input class="easyui-textbox" name="bordTitle" id="r_bordTitle" data-options="required:true,validType:'length[0,100]',width:600"/>
							</td>

						</tr>
						<tr>
							<th style="width:80px"><span data-item="LAB_003">첨부파일</span></th>
							<td>
		    ...
		    <div style="text-align:center;padding:5px">
		        ...
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="remove-button" data-item="BTN_006">삭제</a>
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="list-button" data-item="BTN_007"  >목록</a>
		    </div>
