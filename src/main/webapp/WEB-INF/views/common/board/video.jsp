...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/video.js" />"></script>
...
<style>
	...
	#responsive > video {width:148px; height:98px; display:block;}
	#responsive > video.on {border:2px solid #a52323; width:148px; height:98px;}
...
<div id="zoom-dialog" class="wui-dialog" style="border-top-width:1px;">
	<div id="zoom_video">
		 <video id="playingVideo" width="600" height="330" controls>
