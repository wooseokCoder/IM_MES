...
<!-- BUSINESS JAVASCRIPT -->
<script type="text/javascript" src="<c:url value="/resources/js/common/board/lsqnaForm.js?v=0626A" />"></script>
<script type="text/javascript">
	doInit({
		...
		bordPno:  '${model.bordPno}',
		bordTitle:'${model.bordTitle}'
	});
</script>
<style>
		...
		<div id="regist-panel" class="easyui-panel brd_edit_h" data-options="fit:true">
		    ...
		    <form id="regist-form" method="post">
		    	<fieldset>
					...
					<input type="hidden" name="bordPno"  id="r_bordPno"  value="${model.bordPno}"/>
					...
					<table class="adjust-select">
						...
						<tr>
							<th width="12%"><span data-item="LAB_101">Title</span></th>
						...
						<tr>
							<th width="12%"><span data-item="LAB_102">Add files</span></th>
							<td width="88%">
		    ...
		    <div style="text-align:center;padding:20px">
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="save-button" data-item="BTN_101" data-options="disabled:${INS}">Save</a>
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="remove-button" data-item="BTN_102" data-options="disabled:${DEL}">Delete</a>
		        <a href="javascript:void(0)" class="easyui-linkbutton c6"  id="list-button" data-item="BTN_103"  >List</a>
		    </div>
...
<form id="hidden-form" method="post">
	...
	<input type="hidden" name="bordPno"    id="h_bordPno"    value="${model.bordPno}"/>
	<input type="hidden" name="bordTitle"  id="h_bordTitle"  value="${model.bordTitle}"/>
